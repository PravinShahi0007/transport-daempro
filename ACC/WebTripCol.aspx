<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true" CodeBehind="WebTripCol.aspx.cs" Inherits="ACC.WebTripCol"  Culture="ar-EG" UICulture="ar-EG" MaintainScrollPositionOnPostback="true"  %>
                    ...
                    <table dir="rtl" width="99%" cellpadding="2px">
                        <tr align="right">
                            ...
                            <td style="width: 275px;" align="left" colspan="2">
                               <!-- edited by hanan2 -->
                                <asp:CheckBox ID="ChkStatus" ForeColor = "Red" Text="تم التسليم للفرع" 
                                ...
                                <asp:Button ID="BtnFind" runat="server" ValidationGroup="55"
                                    ToolTip="البحث عن بيانات بيان الترحيل" OnClick="BtnFind_Click"  Text="بحث"/>
                            </td>
                        </tr>
                        <tr align="right">
                            <td style="width: 125px;">
                        ...
                        <tr align="right">
                            <td style="width: 125px;">
                                <asp:Label ID="Label7" runat="server" Visible="false" Text="مدينة أو منطقة التجميع*"></asp:Label>
                            </td>
                            <td style="width: 300px;">
                                <asp:DropDownList ID="ddlFrom" Width="280" runat="server" Visible="false"
                        ...
                        <tr align="right">
                            ...
                            <td style="width: 275px;" colspan="2">
                                ...
                                <asp:RequiredFieldValidator ID="ValDriver" runat="server" ControlToValidate="ddlDriver"
                                    ...
                                    SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                                <asp:TextBox ID="txtRentDriver" Width="280px"  Visible="false" MaxLength="100" runat="server" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr align="right">
                          <td style="width: 125px;">   
                            ...
                            <td style="width: 100px;">
                              <asp:CheckBox ID="ChkAll" Text="عرض المتاح" runat="server" AutoPostBack="True" 
                         ...
                         <tr align="right">
                            ...
                            <td style="width: 300px;">
                                <asp:CheckBoxList ID="ChkInvType" runat="server" Width="190px" 
                                    ...
                                    <asp:ListItem Value="2">بضاعة</asp:ListItem>
                                </asp:CheckBoxList>
                            </td> 
                        </tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="جهة الترحيل" SortExpression="DestinationName1" ItemStyle-HorizontalAlign="Center">
                          ...
                          <asp:TemplateField HeaderText="العنوان" SortExpression="Address" ItemStyle-HorizontalAlign="Center">
                            ...
                            <%--NavigateUrl='<%# "WebMap.aspx?lat=" +Eval("RLat").ToString() + "&lng="+ Eval("RLng").ToString()%>' --%>
                            <ControlStyle Width="150px" />
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:TemplateField>

                          <asp:TemplateField HeaderText="النوع" SortExpression="ShipType" ItemStyle-HorizontalAlign="Center" Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="lblshiptype" Text='<%# Bind("Flag") %>' runat="server"></asp:Label>
                            </ItemTemplate>

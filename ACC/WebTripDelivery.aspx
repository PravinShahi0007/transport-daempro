<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true"
    CodeBehind="WebTripDelivery.aspx.cs" Inherits="ACC.WebTripDelivery" Culture="ar-EG"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
            ...
            <center>
                ...
                <table dir="rtl" width="99%" cellpadding="2px">
                    <tr align="right">
                        ...
                        <td style="width: 300px; margin-right: 40px;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNumber"
                                Display="Dynamic" ErrorMessage="يجب أختيار رقم بيان التوزيع" ForeColor="Red"
                        ...
                        <td style="width: 275px;" align="left" colspan="2">
                            <!-- edited by hanan2 -->
                            <asp:CheckBox ID="ChkRent" runat="server" Text="سائق متعاون" AutoPostBack="True" Visible="false"
                                OnCheckedChanged="ChkRent_CheckedChanged" />
                            &nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtSearch" MaxLength="10" Width="100px" placeholder="بحث" runat="server"></asp:TextBox>
                            <asp:ImageButton ID="BtnFind" runat="server" ValidationGroup="55" ImageUrl="~/images/zoom_16.png"
                                ToolTip="البحث عن بيانات بيان التوزيع" OnClick="BtnFind_Click" Text="بحث" />
                        </td>
                    </tr>
                    <tr align="right">
                        <td style="width: 125px;">
                    ...
                    <tr align="right">
                        <td style="width: 125px;">
                            <asp:Label ID="Label7" Visible="false" runat="server" Text="مدينة أو منطقة التوزيع*"></asp:Label>
                        </td>
                        <td style="width: 300px;">
                            <asp:DropDownList ID="ddlFrom" Visible="false" Width="280" runat="server" >
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="ValFrom" runat="server" ControlToValidate="ddlFrom" Enabled="false"
                                InitialValue="-1" Display="Dynamic" ErrorMessage="يجب أختيار الجهة من" ForeColor="Red"
                                SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 125px;">
                            <asp:Label ID="Label6" Visible="false" runat="server" Text="نوع الناقلة*"></asp:Label>
                        </td>
                        <td style="width: 300px;">
                            <asp:DropDownList ID="ddlType" Width="280" Visible="false" runat="server" OnSelectedIndexChanged="ddlType_SelectedIndexChanged"
                                AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr align="right">
                        ...
                        <td style="width: 275px;" colspan="2">
                            <asp:TextBox ID="txtRentDriver" Visible="false" Width="280px" MaxLength="100" runat="server" ReadOnly="True"></asp:TextBox>
                            <asp:DropDownList ID="ddlCar" Width="280" Visible="false" runat="server"></asp:DropDownList>
                    ...
                    <tr align="right">
                        ...
                        <td style="width: 100px;">
                            <asp:CheckBox ID="ChkAll" Visible="false" Text="عرض المتاح" runat="server" AutoPostBack="True" OnCheckedChanged="ChkAll_CheckedChanged" />
                        </td>
                    </tr>
                    <tr align="right">
                        <td style="width: 125px;">
                        ...
                        <td style="width: 300px;">
                            <asp:CheckBoxList ID="ChkInvType" runat="server" Width="190px" RepeatColumns="2"
                                AutoPostBack="True" OnSelectedIndexChanged="ChkInvType_SelectedIndexChanged">
                    ...
                    <tr align="center">
                        <td colspan="5">
                            <asp:ImageButton ID="BtnNew" runat="server" AlternateText="جديد" CommandName="New"
                                ImageUrl="~/images/insource_642.png" ToolTip="أضافة بيان توزيع جديد" ValidationGroup="1"
                                OnClientClick='return confirm("هل أنت متاكد من حفظ بيان التوزيع؟")' OnClick="BtnNew_Click"
                                Text="جديد" />
                            <asp:ImageButton ID="BtnEdit" runat="server" AlternateText="تعديل" CommandName="Edit"
                                ImageUrl="~/images/draw_pen_642.png" ToolTip="تعديل بيان توزيع" Width="64px"
                            ...
                            <asp:ImageButton ID="BtnDelete" runat="server" AlternateText="إلغاء" CommandName="Delete"
                                ImageUrl="~/images/cut_642.png" ToolTip="إلغاء بيان التوزيع" OnClientClick='return confirm("هل أنت متاكد من الغاء بيان التوزيع؟")'
                                OnClick="BtnDelete_Click" Text="إلغاء" />
    ...
    <br />
    <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
        direction: rtl; border: solid 2px #800000">
        <legend align="right" style="font-size: 18px; color: #800000; text-align: center;"><b>
            [ فواتير الحمولة ]</b></legend>
        <div id="divGrd" runat="server" style="width: 100%; overflow: none; overflow-x: auto;
            border: 1px solid #800000;">
            <!-- edited by hanan ( copy & paste the gridview ) -->
            <asp:GridView ID="grdCodes" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="" HeaderStyle-Width="20px">
                        <ItemTemplate>
                            <asp:CheckBox ID="ChkStatus" runat="server" Checked='<%# Bind("Status1") %>' ToolTip="أختيار او عدم اختيار الفاتورة" />
                        </ItemTemplate>
                        <HeaderStyle Width="20px"></HeaderStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="رقم الفاتورة" SortExpression="VouNo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblVouNo" Text='<%# Eval("Flag") + int.Parse(Eval("VouLoc").ToString()).ToString() + "/" + Eval("VouNo") %>'
                                NavigateUrl='<%# UrlHelper(Eval("VouNo"),Eval("VouLoc"),Eval("Flag"))%>' Target="_blank"
                    ...
                    <asp:TemplateField HeaderText="الشحنة" SortExpression="PlateNo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="جوال المستلم" SortExpression="RecMobileNo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblModel" Text='<%# Bind("RecMobileNo") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <ControlStyle Width="100px" />
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="أسم المرسل/المستلم" SortExpression="RecName"
                    ...
                    <asp:TemplateField HeaderText="العنوان" SortExpression="RecAddress" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        <asp:HyperLink ID="lblRecAddress" Text='<%# Bind("RecAddress") %>'
                                NavigateUrl='<%# "WebMap.aspx?lat=" +Eval("RLat").ToString() + "&lng="+ Eval("RLng").ToString()%>' Target="_blank"
                                runat="server"></asp:HyperLink>
                        </ItemTemplate>

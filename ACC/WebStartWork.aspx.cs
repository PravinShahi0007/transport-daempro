...
namespace ACC
{
    public partial class WebStartWork : System.Web.UI.Page
    {
        public string DocType = "101";
        public string DocName = "إشعار مباشرة عمل";
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (Request.QueryString["FNum"] != null)                
                    {
                        ...
                        if (vLevel != 0) SetDisplayLevel(vLevel.ToString(),Request.QueryString["FNum"].ToString());
                        SearchDoc(Request.QueryString["FNum"].ToString());
                        if (Request.QueryString["FMode"].ToString() != "0")
                        {
                            if (vLevel != 0) EnableLevel((Transfer ? (int.Parse(Request.QueryString["FLevel"].ToString())-1).ToString() : Request.QueryString["FLevel"].ToString()));
                            else EnableLevel("0");                            
                        }
                    }
                }
                ...
                case 8:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer8.Visible = (myService.SType8 == 0);
                                ddlTransfer8.Visible = (myService.SType8 == 0);
                            }
                        }
                        break;
                    }
                case 7:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer7.Visible = (myService.SType7 == 0);
                                ddlTransfer7.Visible = (myService.SType7 == 0);
                            }
                        }
                        break;
                    }
                case 6:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer6.Visible = (myService.SType6 == 0);
                                ddlTransfer6.Visible = (myService.SType6 == 0);
                            }
                        }
                        break;
                    }
                case 5:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer5.Visible = (myService.SType5 == 0);
                                ddlTransfer5.Visible = (myService.SType5 == 0);
                            }
                        }
                        break;
                    }
                case 4:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer4.Visible = (myService.SType4 == 0);
                                ddlTransfer4.Visible = (myService.SType4 == 0);
                            }
                        }
                        break;
                    }
                case 3:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer3.Visible = (myService.SType3 == 0);
                                ddlTransfer3.Visible = (myService.SType3 == 0);
                            }
                        }
                        break;
                    }
                case 2:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer2.Visible = (myService.SType2 == 0);
                                ddlTransfer2.Visible = (myService.SType2 == 0);
                            }
                        }
                        break;
                    }
                case 1:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService != null)
                            {
                                ...
                                lblTransfer1.Visible = (myService.SType1 == 0);
                                ddlTransfer1.Visible = (myService.SType1 == 0);
                            }
                        }
                        break;
                    }
        ...
        public void GetAgree(string Level, string FNum)
        {
            ...
            if (vService != null)
            {
                if (Level == "1")
                {
                    ...
                    ddlTransfer1.Visible = (vService.Agree == 2);
                    lblTransfer1.Visible = (vService.Agree == 2);
                ...
                else if (Level == "2")
                {
                    ...
                    ddlTransfer2.Visible = (vService.Agree == 2);
                    lblTransfer2.Visible = (vService.Agree == 2);
                ...
                else if (Level == "3")
                {
                    ...
                    ddlTransfer3.Visible = (vService.Agree == 2);
                    lblTransfer3.Visible = (vService.Agree == 2);
                ...
                else if (Level == "4")
                {
                    ...
                    ddlTransfer4.Visible = (vService.Agree == 2);
                    lblTransfer4.Visible = (vService.Agree == 2);
                ...
                else if (Level == "5")
                {
                    ...
                    ddlTransfer5.Visible = (vService.Agree == 2);
                    lblTransfer5.Visible = (vService.Agree == 2);
                ...
                else if (Level == "6")
                {
                    ...
                    ddlTransfer6.Visible = (vService.Agree == 2);
                    lblTransfer6.Visible = (vService.Agree == 2);
                ...
                else if (Level == "7")
                {
                    ...
                    ddlTransfer7.Visible = (vService.Agree == 2);
                    lblTransfer7.Visible = (vService.Agree == 2);
                ...
                else if (Level == "8")
                {
                    ...
                    ddlTransfer8.Visible = (vService.Agree == 2);
                    lblTransfer8.Visible = (vService.Agree == 2);
                ...
                else if (Level == "9")
                {
                    ...
                    ddlTransfer9.Visible = (vService.Agree == 2);
                    lblTransfer9.Visible = (vService.Agree == 2);
        ...
        public void EnableLevel(string Level)
        {
                ...
                case 9:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer9.Visible = true;
                                ddlTransfer9.Visible = true;                                
                            }
                            else
                            {
                                BtnDisagree9.Visible = (myService.SType8 == 0);
                                BtnTransfer9.Visible = (myService.SType8 == 0);
                                lblTransfer9.Visible = (myService.SType8 == 0);
                                ddlTransfer9.Visible = (myService.SType8 == 0);
                            }
                        }
                ...
                case 8:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer8.Visible = true;
                                ddlTransfer8.Visible = true;
                            }
                            else
                            {
                                BtnDisagree8.Visible = (myService.SType8 == 0);
                ...
                case 7:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer7.Visible = true;
                                ddlTransfer7.Visible = true;
                            }
                            else
                            {
                                BtnDisagree7.Visible = (myService.SType7 == 0);
                ...
                case 5:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer5.Visible = true;
                                ddlTransfer5.Visible = true;
                            }
                            else
                            {
                                BtnDisagree5.Visible = (myService.SType5 == 0);
                ...
                case 4:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer4.Visible = true;
                                ddlTransfer4.Visible = true;
                            }
                            else
                            {
                                BtnDisagree4.Visible = (myService.SType4 == 0);
                ...
                case 3:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer3.Visible = true;
                                ddlTransfer3.Visible = true;
                            }
                            else
                            {
                                BtnDisagree3.Visible = (myService.SType3 == 0);
                ...
                case 2:
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer2.Visible = true;
                                ddlTransfer2.Visible = true;
                            }
                            else
                            {
                                BtnDisagree2.Visible = (myService.SType2 == 0);
                ...
                case 1:                                        
                    {
                        ...
                        if (vDisp)
                        {
                            if (myService == null)
                            {
                                ...
                                lblTransfer1.Visible = true;
                                ddlTransfer1.Visible = true;
                            }
                            else
                            {
                                BtnDisagree1.Visible = (myService.SType1 == 0);
            ...
            if ((bool)myService.Action1) DivRule1.Visible = true;
            else if ((bool)myService.Action2) DivRule2.Visible = true;
            else if ((bool)myService.Action3) DivRule3.Visible = true;
            else if ((bool)myService.Action4) DivRule4.Visible = true;
            else if ((bool)myService.Action5) DivRule5.Visible = true;
            else if ((bool)myService.Action6) DivRule6.Visible = true;
            else if ((bool)myService.Action7) DivRule7.Visible = true;
            else if ((bool)myService.Action8) DivRule8.Visible = true;
                ...
                if (Page.IsValid)
                {
                    if (txtEmpCode.Text != "")
                    {
                        ...
                        else
                        {
                            ...
                            myService.Status = 0;
                            myService.SDate = txtSDate2.Text;
        ...
        public void SearchDoc(string DocNo)
        {
            ...
            {                
                ...
                if (myService != null)
                {
                    ...
                    txtSDate2.Text = myService.SDate;
        ...
        {
            if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1") moh.AddUserTrans(Session["CurrentUser"].ToString(), "اشعار مباشرة", "طباعة", "طباعة اشعار مباشرة رقم " + Number, "", IPNetworking.GetIP4Address(), WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
        ...
        public void DoAttach(FileUpload fp,string step)
       {
        ...
        protected void BtnAgree1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                if (vOption == "1")
                {
                    ...
                    LblCodesResult1.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "2")
                {
                    ...
                    LblCodesResult2.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "3")
                {
                    ...
                    LblCodesResult3.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "4")
                {
                    ...
                    LblCodesResult4.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "5")
                {
                    ...
                    LblCodesResult5.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "6")
                {
                    ...
                    LblCodesResult6.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "7")
                {
                    ...
                    LblCodesResult7.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "8")
                {
                    ...
                    LblCodesResult8.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                else if (vOption == "9")
                {
                    ...
                    LblCodesResult9.Text = "تم اعتماد الموافقة على المستند بنجاح";
                ...
                if (myService != null)
                {
                    ...
                    if (myService2.StatusUpdate(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                    {
                        ...
                        if (myServiceAgree.Add(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            UserTran.TranTime = String.Format("{0:HH:mm:ss}", moh.Nows());
                            UserTran.UserName = Session["CurrentUser"].ToString();
                            UserTran.Description = "أعتماد بالموافقة على " + DocName +" رقم  " + txtDocNo.Text;
                            ...
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage("تم اعتماد الموافقة على المستند بنجاح", false, true), true);
                        }
                        else
                        {
                            SetError(vOption);
        ...
        protected void BtnDisagree1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                if (vOption == "1")
                {
                    ...
                    txtAgree1UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult1.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult1.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark1.Text;
                    myServiceAgree.AgreeUser = txtAgree1User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree1UserDate.Text;
                }
                else if (vOption == "2")
                {
                    ...
                    txtAgree2UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult2.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult2.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark2.Text;
                    myServiceAgree.AgreeUser = txtAgree2User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree2UserDate.Text;
                }
                else if (vOption == "3")
                {
                    ...
                    txtAgree3UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult3.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult3.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark3.Text;
                    myServiceAgree.AgreeUser = txtAgree3User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree3UserDate.Text;
                }
                else if (vOption == "4")
                {
                    ...
                    txtAgree4UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult4.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult4.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark4.Text;
                    myServiceAgree.AgreeUser = txtAgree4User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree4UserDate.Text;
                }
                else if (vOption == "5")
                {
                    ...
                    txtAgree5UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult5.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult5.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark5.Text;
                    myServiceAgree.AgreeUser = txtAgree5User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree5UserDate.Text;
                }
                else if (vOption == "6")
                {
                    ...
                    txtAgree6UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult6.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult6.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark6.Text;
                    myServiceAgree.AgreeUser = txtAgree6User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree6UserDate.Text;
                }
                else if (vOption == "7")
                {
                    ...
                    txtAgree7UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult7.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult7.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark7.Text;
                    myServiceAgree.AgreeUser = txtAgree7User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree7UserDate.Text;
                }
                else if (vOption == "8")
                {
                    ...
                    txtAgree8UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss}", moh.Nows());
                    LblCodesResult8.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult8.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark8.Text;
                    myServiceAgree.AgreeUser = txtAgree8User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree8UserDate.Text;
                }
                else if (vOption == "9")
                {
                    txtAgree9User.ToolTip = Session["CurrentUser"].ToString(); // "Admin";
                    txtAgree9User.Text = Session["FullUser"].ToString();
                    txtAgree9UserDate.Text = String.Format("{0:dd/MM/yyyy HH:mm:ss tt}", moh.Nows());
                    LblCodesResult9.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult9.Text = "تم اعتماد رفض المستند بنجاح";
                    myServiceAgree.AgreeRemark = txtRemark9.Text;
                    myServiceAgree.AgreeUser = txtAgree9User.ToolTip;
                    myServiceAgree.AgreeUserDate = txtAgree9UserDate.Text;
                ...
                if (myService != null)
                {
                    ...
                    if (myService.StatusUpdate(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                    {
                        ...
                        if (myServiceAgree.Add(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            UserTran.TranTime = String.Format("{0:HH:mm:ss}", moh.Nows());
                            UserTran.UserName = Session["CurrentUser"].ToString();
                            UserTran.Description = "أعتماد الرفض على " + DocName  + " رقم  " + txtDocNo.Text;
                            UserTran.FormAction = "أعتماد";
                            UserTran.FormName = DocName;
                            UserTran.IP = IPNetworking.GetIP4Address();
                            UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                            ...
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage("تم اعتماد رفض المستند بنجاح", false, true), true);
                        }
                        else
                        {
                            SetError(vOption);
        ...
        public void doAgree()
        {
            ...
            if (myEmp != null)
            {
                ...
                myEmp.Status = 0;
                myEmp.ReturnDate = txtSDate2.Text;

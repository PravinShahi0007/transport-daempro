...
namespace ACC
{
    public partial class WebCostCenterResult : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    this.Page.Header.Title = "تقييم مراكز الفروع";
        ...
        protected void BtnPrint1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                {
                    cell2.Phrase = new iTextSharp.text.Phrase("تقييم مراكز الفروع  - " + ddlCenter.SelectedItem.Text, nationalTextFont14);
                }
                else
                {
                    cell2.Phrase = new iTextSharp.text.Phrase("تقييم مراكز الفروع  -  " + ddlCenter.SelectedItem.Text + " " + txtFDate.Text + " إلى " + txtEDate.Text, nationalTextFont14);
                }
                table.AddCell(cell2);
                ...
                cell.Phrase = new iTextSharp.text.Phrase("رقم الفرع", nationalTextFont2);
                table.AddCell(cell);
                ...
                cell.Phrase = new iTextSharp.text.Phrase("نسبة الايراد", nationalTextFont2);
                table.AddCell(cell);

                cell.Phrase = new iTextSharp.text.Phrase("المصروف", nationalTextFont2);
                table.AddCell(cell);

                cell.Phrase = new iTextSharp.text.Phrase("نسبة المصروف", nationalTextFont2);
                table.AddCell(cell);

                cell.Phrase = new iTextSharp.text.Phrase("الربحية", nationalTextFont2);
                table.AddCell(cell);

                cell.Phrase = new iTextSharp.text.Phrase("نسبة الربحية", nationalTextFont2);
                table.AddCell(cell);
                ...
                if (MyOver != null && MyOver.Count > 0)
                {
                    foreach (vCostCenterResult inv in MyOver)
                    {
                        ...
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}%", inv.NetPer), nationalTextFont);
                        table.AddCell(cell);
                    }
                    cell.BackgroundColor = iTextSharp.text.BaseColor.LIGHT_GRAY;
        ...
        protected void BtnProcess_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                MyOver = myInv.GetAll(int.Parse(this.ddlCenter.SelectedValue),txtFDate.Text, txtEDate.Text, WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);

                Chart1.DataSource = MyOver.OrderBy(c => c.Code);
                Chart1.Series["Categories"].XValueMember = "Name1";
                Chart1.Series["Categories"].YValueMembers = "Expenses";
                Chart1.DataBind();


                Chart2.DataSource = MyOver.OrderBy(c => c.Code);
                Chart2.Series["Categories2"].XValueMember = "Name1";
                Chart2.Series["Categories2"].YValueMembers = "Income";
                Chart2.DataBind();

                Chart3.DataSource = MyOver.OrderBy(c => c.Code);
                Chart3.Series["Categories3"].XValueMember = "Name1";
                Chart3.Series["Categories3"].YValueMembers = "Expenses";

                Chart3.Series["Categories30"].XValueMember = "Name1";
                Chart3.Series["Categories30"].YValueMembers = "Income";
                Chart3.DataBind();


                Chart4.DataSource = MyOver.OrderBy(c => c.Code);
                Chart4.Series["Categories4"].XValueMember = "Name1";
                Chart4.Series["Categories4"].YValueMembers = "Net";
                Chart4.DataBind();
        ...
        protected void grdCodes_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                double Net = (double)MyOver[e.Row.RowIndex].Net;

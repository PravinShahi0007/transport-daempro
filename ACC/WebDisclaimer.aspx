<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true" CodeBehind="WebDisclaimer.aspx.cs" Inherits="ACC.WebDisclaimer"  Culture="auto:ar-EG" UICulture="auto" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="ColorRounded4Corners" style="width: 99.9%" dir="rtl">
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99.8%;
            ...
            <legend align="right" style="font-size: 18px; color: #800000; text-align: center;">[إخلاء طرف موظف]</legend>
            <center>
                <asp:Label ID="Label10" style="font-size: 18px; color: #800000; text-align: center;" runat="server" Text="ويخص الأدوات  - السيارة - إنهاء ما ترتب عليه من عمل"></asp:Label>
                <table width="99.5%">
                    <tr>
                    ...
                    <tr>
                        <td align="right" style="width: 120px;">
                            <asp:Label ID="Label6" runat="server" Text="سبب إخلاء الطرف*"></asp:Label>
                        </td>
                        <td align="right" style="width: 280px;">
                            <asp:DropDownList ID="ddlFType" runat="server" AutoPostBack="True" 
                                OnSelectedIndexChanged="ddlFType_SelectedIndexChanged">
                                <asp:ListItem Text="--- أختر السبب ---" Value="-1" ></asp:ListItem>
                                <asp:ListItem Text="لإنتهاء الخدمة" Value="0" ></asp:ListItem>
                                <asp:ListItem Text="للإجازة العادية" Value="1" ></asp:ListItem>
                                <asp:ListItem Text="للإجازة الاضطرارية" Value="2" ></asp:ListItem>
                                <asp:ListItem Text="لأسباب أخرى" Value="3" ></asp:ListItem>
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlFType"
                                Display="Dynamic" ErrorMessage="يجب أختيار سبب إخلاء الطرف" ForeColor="Red" SetFocusOnError="True"
                                InitialValue="-1" ValidationGroup="1">*</asp:RequiredFieldValidator>
                        </td>
                        <td align="right" style="width: 120px;">
                            <asp:Label ID="Label32" runat="server" Text="السبب"></asp:Label>*
                         </td>
                        <td align="right" style="width: 280px;">
                            <asp:TextBox ID="txtNotes2" Width="200px" MaxLength="100" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtNotes2"
                                Display="Dynamic" ErrorMessage="يجب إدخال السبب" ForeColor="Red" 
                                SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            <asp:TextBox ID="txtEDate" Width="100px" MaxLength="10" runat="server" Visible="false"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtEDate"
                                Display="Dynamic" ErrorMessage="يجب أختيار تاريخ نهاية العقد" ForeColor="Red" Enabled="false"
                                SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            <ajax:CalendarExtender ID="CalendarExtender3" runat="server" CssClass="MyCalendar" Enabled="false"
                    ...
                    <tr>
                        <td align="right" style="width: 120px;">
                            <asp:Label ID="Label31" runat="server" Text="تاريخ إخلاء الطرف*"></asp:Label>
                        </td>
                        <td align="right" style="width: 280px;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSDate"
                                Display="Dynamic" ErrorMessage="يجب أختيار تاريخ إخلاء الطرف" ForeColor="Red"
                                SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="3">
                            <asp:Label ID="Label7" runat="server" Text="نشهد نحن الموافقين على الطلب بأن المذكور اسمة وبياناته عاليه يعد خالي الطرف أعتباراً من اليوم المذكور عاليه ويمكن له صرف مستحقاته وكذا تسليمه جواز سفره مالم يذكر فيما يلي أي ملاحظات تجول دون ذلك ويتعين أخذها في الاعتبار قبل الصرف أو تسليمه جواز سفره"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 120px;">

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="mdiv3" runat="server" class="Rounded4Corners div3" style="<%$ Resources: mDiv1 %>">
        <center>
            <b>
                <asp:Label ID="Label6" ForeColor="#800000" Font-Underline="true" runat="server" Text="[ أرصدة الفرع ]"></asp:Label></b>
    ...
    <div class="Rounded4Corners div1" style="width: 915px; border: thin solid #800000;">
        <table width="100%">
            <tr>
                <td colspan="2">
                    <asp:RadioButtonList ID="RdoActive" runat="server" CellPadding="2" CellSpacing="2"
                        ...
                        <asp:ListItem Selected="True" Value="1">نقل سيارات</asp:ListItem>
                        <asp:ListItem Value="2">نقل بضاعة</asp:ListItem>
                        <asp:ListItem Value="3">نقل طرود</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
                <td>
                    <b>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label13" runat="server" Text="فترة البحث"></asp:Label>
                </td>
                <td colspan="4">
    ...
    <div id="ProcessDiv" runat="server">
            ...
            <asp:GridView ID="grdTrackMove" runat="server" CellPadding="4" ForeColor="#333333"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:CarMove %>" SortExpression="CarMoveNo"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCarMoveNo" Text='<%# Eval("CarMoveNo") %>' ToolTip="عرض بيان الترحيل"
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:RCVTime %>" SortExpression="RCVFTime"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblRCVFTime" Text='<%# Eval("RCVFTime") %>' ToolTip="اصدار بيان وصول"
            ...
            <asp:GridView ID="grdTrackMove2" CellPadding="4" AutoGenerateColumns="False" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:CarNo %>" SortExpression="Code" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCode2" Text='<%# Eval("Code").ToString() + "<br/>" + Eval("PlateNo").ToString() %>'
                                ToolTip="اصدار سند صرف" NavigateUrl='<%# UrlHelper("21" ,Eval("CarMoveNo"))%>'
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:CarMove %>" SortExpression="CarMoveNo"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCarMoveNo2" Text='<%# Eval("CarMoveNo") %>' ToolTip="عرض بيان الترحيل"
                                NavigateUrl='<%# UrlHelper("1" ,Eval("CarMoveNo"))%>' Target="_blank" runat="server"></asp:HyperLink>
                        </ItemTemplate>
                        <ControlStyle Width="75px" />
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:CarMoveRCV %>" SortExpression="CarMoveRCVNo"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCarMoveRCVNo" Text='<%# Eval("CarMoveRCVNo") %>' ToolTip="عرض بيان الوصول"
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
            ...
            <legend align="center" style="font-size: 18px; color: #800000; text-align: center;">
                <b>[<a target="_blank" href='<%= string.Format("WebTrackMoveOut.aspx?AreaNo={0}&StoreNo={1}",AreaNo,StoreNo) %>'>&nbsp;<i
                    class="fa fa-tv"></i></a> الشاحنات المغادرة من الفرع ]</b></legend>
            <asp:GridView ID="grdTrackMove1" CellPadding="4" AutoGenerateColumns="False" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="بيان الترحيل" SortExpression="CarMoveNo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCarMoveNo1" Text='<%# Eval("CarMoveNo") %>' ToolTip="عرض بيان الترحيل"
                                NavigateUrl='<%# UrlHelper("1" ,Eval("CarMoveNo"))%>' Target="_blank" runat="server"></asp:HyperLink>
                        </ItemTemplate>
                        <ControlStyle Width="75px" />
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
            border: solid 2px #800000">
            <legend align="center" style="font-size: 18px; color: #800000; text-align: center;">
                <b>[ شاحنات في طريقها للصيانة ]</b></legend>
            <div style="width: 100%; text-align: left;">
            ...
            <asp:GridView ID="grdWSTrackMove" runat="server" CellPadding="4" ForeColor="#333333"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:RepairReqNo %>" SortExpression="VouNo"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblRepairReqNo" Text='<%# Eval("VouNo2") %>' ToolTip="عرض طلب الاصلاح"
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:CarMove %>" SortExpression="CarMove"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCarMoveNo" Text='<%# Eval("CarMove") %>' ToolTip="عرض بيان الترحيل"
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:Dest %>" SortExpression="SiteName1"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblCarMoveFromLoc" Text='<%# Eval("SiteName1") %>' ToolTip="فتح أمر التشغيل"
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
            border: solid 2px #800000">
            <legend align="center" style="font-size: 18px; color: #800000; text-align: center;">
                <b>[ شاحنات جاري صيانتها الآن ]</b></legend>
            <div style="width: 100%; text-align: left;">
            ...
            <asp:GridView ID="grdWSInTrackMove" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:JobWorkNo %>" SortExpression="JobWorkVouNo2"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblJobWorkNo" Text='<%# Eval("JobWorkVouNo2") %>' ToolTip="عرض أمر التشغيل"
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
            border: solid 2px #800000">
            <legend align="center" style="font-size: 18px; color: #800000; text-align: center;">
                <b>[ شاحنات غادرت الصيانة ]</b></legend>
            <div style="width: 100%; text-align: left;">
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
            border: solid 2px #800000">
            <legend align="center" style="font-size: 18px; color: #800000; text-align: center;">
                <b>[ سيارات في الساحة في انتظار ترحيلها ]</b></legend>
            <div style="width: 100%; text-align: left;">
            ...
            <asp:GridView ID="grdOverCarMove" runat="server" CellPadding="4" ForeColor="#333333"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="رقم الفاتورة" SortExpression="VouNo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblVouNo" Text='<%# Eval("Flag").ToString()+int.Parse(Eval("InvoiceVouLoc").ToString()).ToString() + "/" + Eval("VouNo") %>'
                                ...
                                ToolTip="عرض الفاتورة" Target="_blank" runat="server"></asp:HyperLink>
                        </ItemTemplate>
                        <ControlStyle Width="100px" />
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="مرسل السيارة/مستلم السيارة" SortExpression="RecName"
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="grdOverTrip" runat="server" CellPadding="4" ForeColor="#333333"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="" HeaderStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ChkStatus" runat="server" AutoPostBack="true" Checked='<%# Bind("Status") %>'
                                                    ToolTip="دمج الرحلة" OnCheckedChanged="ChkStatus_CheckedChanged" />
                                            </ItemTemplate>
                                            <HeaderStyle Width="20px"></HeaderStyle>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="رقم الرحلة" SortExpression="FNo" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="lblFNo1" Text='<%# Bind("FNo") %>' NavigateUrl='<%# UrlHelper(4,Eval("Destination").ToString())%>'
                                                    ToolTip="أصدار بيان ترحيل للرحلة" runat="server"></asp:HyperLink>
                                            </ItemTemplate>
                                            <ControlStyle Width="75px" />
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="متجهة إلى" SortExpression="DestinationName1" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDestinationName" Text='<%# Bind("DestinationName1") %>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="الحمولة" SortExpression="Model" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblModel" Text='<%# Bind("Model") %>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle Width="50px" />
    ...
    <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99%;
        ...
        <asp:GridView ID="grdCarAlert" runat="server" CellPadding="4" ForeColor="Black" GridLines="Vertical"
            AutoGenerateColumns="False" DataKeyNames="Code" Width="99.9%" EmptyDataText="لا توجد بيانات"
    ...
    <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99%;
        ...
        <asp:GridView ID="grdCarAlert2" runat="server" CellPadding="4" ForeColor="Black"
            ...
            EmptyDataText="لا توجد بيانات" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None"
            BorderWidth="1px">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:TemplateField HeaderText="م" SortExpression="WorkShopCode" ItemStyle-HorizontalAlign="Center">
                ...
                <asp:TemplateField HeaderText="الرقم" SortExpression="Code" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="lblCarNo" Text='<%# Eval("Code") %>' NavigateUrl='<%# UrlHelper("110" ,Eval("Code"))%>'
                            ToolTip="عرض السيارة" Target="_blank" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                    <ControlStyle Width="80px" />
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="الرقم" SortExpression="Code" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="lblCarNo" Text='<%# Eval("Code") %>' NavigateUrl='<%# UrlHelper("222" ,Eval("Code"))%>'
                            ToolTip="عرض بيانات الموظف" Target="_blank" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                    <ControlStyle Width="80px" />
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
    ...
    <div runat="server" id="DivAccBal">
            ...
            <center>
                <b>
                    <asp:Label ID="LblBanks" ForeColor="#800000" Font-Underline="true" runat="server"
                        Text="[ البنوك ]"></asp:Label></b></center>
        ...
        <div id="Div2" runat="server" class="Rounded4Corners div2" style="<%$ Resources: mDiv1 %>">
            <center>
                <b>
                    <asp:Label ID="Label8" ForeColor="#800000" Font-Underline="true" runat="server" Text="[ النقدية ]"></asp:Label></b></center>
        ...
        <div id="Div3" runat="server" class="Rounded4Corners div3" style="<%$ Resources: mDiv1 %>">
            <center>
                <b>
                    <asp:Label ID="Label9" ForeColor="#800000" Font-Underline="true" runat="server" Text="[ العهد ]"></asp:Label></b>
            </center>
            ...
            <center>
                <b>
                    <asp:Label ID="Label22" ForeColor="#800000" Font-Underline="true" runat="server"
                        Text="[ العملاء ]"></asp:Label></b></center>
        ...
        <div id="DivVendors" runat="server" class="Rounded4Corners div1" style="<%$ Resources: mDiv1 %>">
            <center>
                <b>
                    <asp:Label ID="Label7" ForeColor="#800000" Font-Underline="true" runat="server" Text="[ الموردين ]"></asp:Label></b></center>
            ...
            <center>
                <b>
                    <asp:Label ID="Label10" ForeColor="#800000" Font-Underline="true" runat="server"
                        Text="[ تأمينات مستحقة ]"></asp:Label></b></center>
            ...
            <center>
                <b>
                    <asp:Label ID="Label11" ForeColor="#800000" Font-Underline="true" runat="server"
                        Text="[  ايجارات مستحقة  ]"></asp:Label></b></center>
            ...
            <center>
                <b>
                    <asp:Label ID="Label12" ForeColor="#800000" Font-Underline="true" runat="server"
                        Text="[ أقساط مستحقة ]"></asp:Label></b></center>
    ...
    <div style="width: 100%;">
        <table width="100%" cellpadding="2" cellspacing="2">
            <tr>
                ...
                <td align="left">
                    <asp:CheckBox ID="ChkAutoUpdate" Text="تحديث تلقائي" runat="server" AutoPostBack="True"
    ...
    <div id="DivInfo" runat="server" class="Rounded4Corners div1" style="<%$ Resources: mDivInfo %>">
        ...
        <table style='width: 100%;'>
            ...
            <tr>
                <td>
                    <a id="myState" href="WebStatement.aspx" target="_blank">كشف حساب</a>
                </td>
            </tr>
        </table>
    </div>

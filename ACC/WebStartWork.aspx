<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true"
    CodeBehind="WebStartWork.aspx.cs" Inherits="ACC.WebStartWork" Culture="auto:ar-EG"
        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99.8%;
            ...
            <center>
                <table width="99.5%">
                    ...
                    <tr>
                        <td align="right" style="width: 100px;">
                            <asp:Label ID="Label6" runat="server" Text="نوع المباشرة"></asp:Label>
                        </td>
                        <td align="right" style="width: 300px;">
                            <asp:DropDownList ID="ddlFType" runat="server">
                                <asp:ListItem Value="1" Text="بعد العودة من الإجازة"></asp:ListItem>
                                <asp:ListItem Value="2" Text="قادم بفيزا عمل"></asp:ListItem>
                                <asp:ListItem Value="3" Text="قادم نقل كفالة"></asp:ListItem>
                                <asp:ListItem Value="4" Text="تعيين جديد"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td align="right" style="width: 100px;">
                        ...
                        <td align="right" style="width: 300px;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSDate2"
                                ...
                                ValidationGroup="1">*</asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtSDate2"
                                CultureInvariantValues="true" Display="Dynamic" ErrorMessage="يجب أن تكون القيمة تاريخ"
                                ForeColor="Red" Type="Date" ValidationGroup="1" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>
                            <ajax:CalendarExtender ID="CalendarExtender2" runat="server" CssClass="MyCalendar"
                                TargetControlID="txtSDate2" Format="dd/MM/yyyy" Animated="true" FirstDayOfWeek="Saturday"
                                PopupPosition="BottomLeft" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="3">
                            <asp:Label ID="Label10" runat="server" Text="إقرار مباشرة عمل في التاريخ المذكور أعلاه باشر الموظف المذكور العمل"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 100px;">
                        ...
                        <td align="center" colspan="3" rowspan="3">
                            <asp:ImageButton ID="BtnNew" runat="server" AlternateText="جديد" CommandName="New"
                             ...
                             <asp:ImageButton ID="BtnEdit" runat="server" AlternateText="تعديل" CommandName="Edit" Visible="false"
                                    ImageUrl="~/images/draw_pen_642.png"   ToolTip="تعديل بيانات السند" OnClientClick='return confirm("هل أنت متاكد من حفظ بيانات السند؟")'
                ...
                <div style="width: 99.5%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                    <asp:GridView ID="grdCodes" runat="server" CellPadding="4" ForeColor="#333333" ShowFooter="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="تاريخ المباشرة" SortExpression="sDate" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="lblsDate" Text='<%# Bind("sDate") %>' runat="server"></asp:Label>
                                </ItemTemplate>
                                <ControlStyle Width="150px" />
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
                    ...
                    <div id="divAgree1" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree11" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule1" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label31" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                    ...
                    <div id="divAgree2" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree21" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule2" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                    ...
                    <div id="divAgree3" runat="server" visible="false" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree31" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule3" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label32" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                    ...
                    <div id="divAgree4" runat="server" visible="false" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree41" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule4" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label33" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                    ...
                    <div id="divAgree5" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree51" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule5" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label35" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                    ...
                    <div id="divAgree6" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree61" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule6" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label36" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                    ...
                    <div id="divAgree7" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree71" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule7" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label37" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                    ...
                    <div id="divAgree8" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree81" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule8" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label38" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                                    <asp:BulletedList ID="BulletedList7" runat="server">
                                        <asp:ListItem Text="تفعيل حساب الموظف على النظام - في حالة وجود حساب له على النظام"></asp:ListItem>
                                        <asp:ListItem Text="تحديث تاريخ المباشرة في ملف البيانات الأساسية للموظف"></asp:ListItem>
                                        <asp:ListItem Text="أرسال رسالة أو ايميل للموظف توضح له الموافقة على الطلب"></asp:ListItem>
                                    </asp:BulletedList>
                    ...
                    <div id="divAgree9" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree91" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule9" visible="false" runat="server" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label39" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                                    <asp:BulletedList ID="BulletedList8" runat="server">
                                        <asp:ListItem Text="تفعيل حساب الموظف على النظام - في حالة وجود حساب له على النظام"></asp:ListItem>
                                        <asp:ListItem Text="تحديث تاريخ المباشرة في ملف البيانات الأساسية للموظف"></asp:ListItem>
                                        <asp:ListItem Text="أرسال رسالة أو ايميل للموظف توضح له الموافقة على الطلب"></asp:ListItem>
                                    </asp:BulletedList>

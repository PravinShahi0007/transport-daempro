<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true" CodeBehind="WebCarIssueAM.aspx.cs" Inherits="ACC.WebCarIssueAM" Culture="ar-EG" UICulture="ar-EG" MaintainScrollPositionOnPostback="true"  %>
                    ...
                    <table width="99%">
                        <tr>
                            <td style="width: 100px">
                                <asp:CheckBox ID="ChkPeriod" runat="server" Checked="True" Text="جميع الفترات" AutoPostBack="True" meta:resourcekey="ChkPeriod" oncheckedchanged="ChkPeriod_CheckedChanged" />
                            </td>
                            <td align="right" >

...
namespace ACC
{
    public partial class WebPurchaseInvoice : System.Web.UI.Page
    {
        ...
        public void EditMode()
        {
            ...
            BtnPrint.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass335;
            BtnEdit.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass332;
            BtnNew.Visible = false;
            BtnDelete.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass333;
        }
        ...
        public void NewMode()
        {
            ...
            BtnNew.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass331;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    this.Page.Header.Title = "Purchase Invoice";

                    BtnNew.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass331;
                    BtnEdit.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass332;
                    BtnDelete.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass333;
                    BtnSearch.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass334;
                    BtnPrint.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass335;
                    BtnFind.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass334;

                    if (Request.QueryString["FNum2"] != null)
                    {
                        BtnClear_Click(sender, null);
                        txtRefNo.Text = Request.QueryString["FNum2"].ToString();
                    ...
                    else
                    {
                        ...
                        if (Request.QueryString["ManInventory"] != null && Session["ManInventory"] != null)
                        {
                            ...
                            {
                                txtRefNo.Text = Request.QueryString["Ref"].ToString();
                                BtnFind2_Click(sender, null);
                            }
            ...
            try
            {
                if (e.CommandName.Equals("Insert"))
                {
                    ...
                    if (myStock != null)
                    {
                        ...
                        myAccess.CrCode = txtCode.Text;
                        myAccess.DbCode = (rdoInvType.SelectedIndex == 0 ? ShopArea.CPur_Acc + moh.MakeMask(StoreNo, 2) + myStock.CPur_Acc : ShopArea.CrPur_Acc + moh.MakeMask(StoreNo, 2) + myStock.CrPur_Acc);
                    }
        ...
        protected void BtnNew_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    if (txtExpAmount.Text == "") txtExpAmount.Text = "0";
                    ...
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
                        LblCodesResult.Text = "Duplicate Purchase Invoice No.";
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                        if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                        return;
                    }
                    else
                    {
                        ...
                        foreach (vSTP itm in VouData)
                        {
                            ...
                            myJv.CrCode = txtCode.Text;       
                            myJv.DbCode = itm.DbCode;
                            myJv.ExpAmount = double.Parse(txtExpAmount.Text);
                            myJv.ExpRef = txtExpRef.Text;
                        ...
                        if (moh.StrToDouble(txtTax.Text) > 0)
                        {
                            ...
                            mJv.FNo = FNo;
                            mJv.Post = 1;
                            mJv.DbCode = "120409001";  // Here Account;
                            mJv.CrCode = "";
                            mJv.FDate = moh.CheckDate(txtVouDate.Text);
                        ...
                        if (myJv.Delete(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            foreach (vSTP itm in myList)
                            {
                                if (itm.ExpAmount != 0)
                                {
                                    ...
                                    vJv.FNo = FNo;
                                    vJv.Post = 1;
                                    vJv.DbCode = itm.DbCode;  // Here Account;
                                    vJv.CrCode = "";
                            ...
                            if (moh.StrToDouble(txtTax.Text) > 0)
                            {
                                ...
                                vJv.FNo = FNo;
                                vJv.Post = 1;
                                vJv.DbCode = "120409001";  // Here Account;
                                vJv.CrCode = "";
                                vJv.FDate = moh.CheckDate(txtVouDate.Text);
        ...
        protected void BtnDelete_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
                        LblCodesResult.Text = "Purchase Invoice No. Not Found";
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                        if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                        return;
                    }
                    else
                    {
                        ...
                        {
                            LblCodesResult.ForeColor = System.Drawing.Color.Red;
                            LblCodesResult.Text = "Purchase Invoice No. Related to another Voucher";
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                            if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                            return;
                        }
                        ...
                        if (myJv.Delete(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            UserTran.Description = "Delete Purchase Invoice No. " + txtVouNo.Text;
                            UserTran.FormAction = "Delete";
                            UserTran.FormName = "Purchase Invoice";
            ...
            try
            {
                if (txtVouNo.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        txtExpAmount.Text = myJv.ExpAmount.ToString();
                        txtExpRef.Text = myJv.ExpRef;
                ...
                {
                    LblCodesResult.ForeColor = System.Drawing.Color.Red;
                    LblCodesResult.Text = "You Should Enter Purchase Invoice No.";
                    if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                    ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                }
            }
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ajax", @"<script language='javascript'> window.open('WebPrint.aspx?FType=204&AreaNo=" + StoreNo + "&Number=" + Number + "');</script>", false);
            return;
        }
        ...
        protected void BtnFind2_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (txtRefNo.Text != "")
                {
                    ...
                    {
                        if (itm.VouNo != int.Parse(txtVouNo.Text) && itm.Ftype == 501)
                        {
                            vFind = true;
                            VouNo = itm.VouNo;
                            break;
                    ...
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
                        LblCodesResult.Text = "Delivery Note No. Used before in same Purchase Invoice No. ";
                        if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                        return;
                    }
                    ...
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
                        LblCodesResult.Text = "Delivery Note No. Not Found";
                        if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                        return;
                    }
                    ...
                    {
                        vFind = false;
                        foreach (vSTP itm in myJv.Find3(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            vStock myStock = new vStock();
                            myStock.Branch = short.Parse(Session["Branch"].ToString());
                            myStock.Number = short.Parse(StoreNo);
                            ...
                            VouData.Add(
                                            new vSTP
                                            {
                                                ...
                                                DbCode = (rdoInvType.SelectedIndex == 0 ? ShopArea.CPur_Acc + moh.MakeMask(StoreNo, 2) + myStock.CPur_Acc : ShopArea.CrPur_Acc + moh.MakeMask(StoreNo, 2) + myStock.CrPur_Acc),
                                                CrCode = txtCode.Text,
                                                FNo2 = itm.FNo,
                        ...
                        {
                            LblCodesResult.ForeColor = System.Drawing.Color.Red;
                            LblCodesResult.Text = "Closed Delivery Note No. and Used before in Purchase Invoice No. " + VouNo.ToString();
                            if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                            return;
                        }

...
namespace ACC
{
    public partial class WebPrices2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    if (Request.QueryString["Customer"] != null) ddlCustomer.SelectedValue = Request.QueryString["Customer"].ToString();
                    if (Request.QueryString["Level"] != null) ddlLevel.SelectedValue = Request.QueryString["Level"].ToString();
                    if (Request.QueryString["City"] != null) ddlCity.SelectedValue = Request.QueryString["City"].ToString();
                    LoadCodesData();
                }
                else
                {
        ...
        protected void grdCodes_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                if (txtKMeter == null || txtLOneWay == null || txtHOneWay == null || txtLTwoWay == null || txtHTwoWay == null || txtCostAmount == null || txtFTime == null || txtEPrice1 == null || txtEPrice2 == null || txtEPrice3 == null)
                {
                    e.Cancel = true;
                    LblCodesResult.ForeColor = System.Drawing.Color.Red;
        ...
        protected void grdCodes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.Equals("Insert"))
                {
                    ...
                    if (txtKMeter == null || txtLOneWay == null || txtHOneWay == null || txtLTwoWay == null || txtHTwoWay == null || ddlFromCode2 == null || ddlToCode2 == null || txtCostAmount == null || txtFTime == null || txtE21Price == null || txtE22Price == null || txtE23Price == null)
                    {
                        grdCodes_RowCancelingEdit(sender, null);
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
        ...
        protected void BtnEdit_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    {
                        string FromCode = grdCodes.DataKeys[gvr.RowIndex]["FromCode"].ToString();
                        string ToCode = grdCodes.DataKeys[gvr.RowIndex]["ToCode"].ToString();
                        ...
                        if (txtKMeter == null || txtLOneWay == null || txtHOneWay == null || txtLTwoWay == null || txtHTwoWay == null || txtCostAmount == null || txtFTime == null || txtEPrice1 == null || txtEPrice2 == null || txtEPrice3 == null || txtAction == null)
                        {
                            continue;
                        }
                        ...
                        if (txtAction.Value != "")
                        {
                            ...
                            myAccess.ExPrice2 = moh.StrToDouble(txtEPrice2.Text);
                            myAccess.ExPrice3 = moh.StrToDouble(txtEPrice3.Text);
                            myAccess.update(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
                        }
                    }
                    LblCodesResult.ForeColor = System.Drawing.Color.Green;
                    LblCodesResult.Text = "لقد تم تعديل البيانات بنجاح";

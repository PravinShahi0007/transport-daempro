<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true" CodeBehind="WebCreditInvRep.aspx.cs" Inherits="ACC.WebCreditInvRep" Culture="ar-EG"
                    ...
                    <table width="99%">
                        ...
                        <tr>
                            <td colspan="2" align="right">
                                <asp:CheckBox ID="ChkSite" runat="server" Checked="True" 
                                    Text="جميع فروع التحصيل" AutoPostBack="True" 
                                    oncheckedchanged="ChkSite_CheckedChanged"/>
                            </td>
                            <td colspan="2" align="right">                                
                                <asp:DropDownList ID="ddlSite" Visible="false" Width="100%" runat="server" 

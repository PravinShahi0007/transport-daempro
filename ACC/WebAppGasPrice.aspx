...
<div class="Round4Courner" style="width: 98%">
            <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
                ...
                <legend align="right" style="font-size: 18px; color: #800000; text-align: center;"><b>
                    [بطاقة تسعير الغاز / التطبيق ]</b></legend>
                <center>
                    <br />
                    <table dir="rtl" width="99%" cellpadding="2px">
                         ...
                         <tr align="right" >
                          <td style="width: 125px;">
                            ...
                            <td style="width: 300px; margin-right: 40px;">
                                <asp:TextBox ID="txtNumber" MaxLength="10" runat="server" CssClass="MouseStop" ReadOnly="True" Width="60px" Visible="False"></asp:TextBox>
                        ...
                        <tr align="right">
                            ...
                            <td style="width: 300px;">
                                <asp:DropDownList ID="ddlcyl" Width="150px" runat="server" AutoPostBack="True" onselectedindexchanged="ddlcyl_SelectedIndexChanged" >

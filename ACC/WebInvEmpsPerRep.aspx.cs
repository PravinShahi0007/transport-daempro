...
namespace ACC
{
    public partial class WebInvEmpsPerRep : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    this.Page.Header.Title = "معدل أداء موظفي الفروع";
        ...
        protected void BtnPrint1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                {
                    cell2.Phrase = new iTextSharp.text.Phrase("معدل أداء موظفي الفروع عن جميع الفترات ", nationalTextFont16);
                }
                else
                {
                    cell2.Phrase = new iTextSharp.text.Phrase("معدل أداء موظفي الفروع عن الفترة من  " + txtFDate.Text + " إلى " + txtEDate.Text, nationalTextFont16);
                }
                table.AddCell(cell2);
                ...
                document.Add(new iTextSharp.text.Phrase("            ", nationalTextFont));
                //-------------------------------------------------------------------------------------------
                cols = new[] { 90,90, 90, 90, 90, 90, 250, 50 };
                ...
                cell.Phrase = new iTextSharp.text.Phrase("أسم الموظف", nationalTextFont2);
                table.AddCell(cell);
                ...
                if (MyOver != null && MyOver.Count > 0)
                {
                    foreach (vInvEmpPer inv in MyOver)
                    {
                        ...
                        cell.Phrase = new iTextSharp.text.Phrase(inv.FullName, nationalTextFont);
                        table.AddCell(cell);
        ...
        protected void BtnProcess_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                MyOver = myInv.vInvEmpPerGetAll(txtFDate.Text, txtEDate.Text, WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString, (List<TblUsers>)(Cache["Users" + Session["CNN2"].ToString()]));
                Chart1.DataSource = MyOver.OrderByDescending(c => c.Total);
                ...
                Chart1.Series["Categories"].XValueMember = "FullName";
        ...
        protected string UrlHelper(object UserName)
        {
            return "~/WebInvEmpPerRep.aspx?UserName=" + UserName.ToString();
        }

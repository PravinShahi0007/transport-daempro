...
namespace ACC
{
    public partial class WebStartWork2 : System.Web.UI.Page
    {
        ...
        public void doAgree()
        {
            ...
            if (myEmp != null)
            {
                ...
                if(ddlFType.SelectedValue != "1")  myEmp.JoinDate = txtSDate2.Text;

...
namespace ACC
{
    public partial class WebTotSalRep : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    this.Page.Header.Title = "كشف أجماليات الرواتب";
                    ...
                    if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                    {
                        ...
                        UserTran.Description = "اختيار عرض كشف اجماليات الرواتب";
        ...
        protected void LoadCodesData()
        {
            ...
            {
                int fno = 1;
                List<Salaries> MyOver2 = new List<Salaries>();
                if (ddlMonth.SelectedIndex == 0)
                {                    
                    SEmp myacc = new SEmp();
                    MyOver2 = (from itm in myacc.GetAll2(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString)
                              select new Salaries
                              {
                                  FNo = (short)fno++,
                                  Year1 = 0,
                ...
                else
                {
                    ...
                    MyOver2 = myacc.GetAllSalary(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
                }
                fno = 1;
                MyOver = (from itm in MyOver2
                          group itm by new { itm.Section, itm.Name1 }                          
                          into g
                          ...
                          select new Salaries
                          {
                              FNo = (short)fno++,
                               ...
                               Name = g.Key.Name1,
                               Basic = g.Sum(p => p.Basic),
                               Add01 = g.Sum(p => p.Add01),
                               Add02 = g.Sum(p => p.Add02),
                               Add03 = g.Sum(p => p.Add03),
                               Add04 = g.Sum(p => p.Add04),
                               Add05 = g.Sum(p => p.Add05),
                               Add06 = g.Sum(p => p.Add06),
                               Add07 = g.Sum(p => p.Add07),
                               Add08 = g.Sum(p => p.Add08),
                               Add09 = g.Sum(p => p.Add09),
                               Add10 = g.Sum(p => p.Add10),
                               Add11 = g.Sum(p => p.Add11),
                               Add12 = g.Sum(p => p.Add12),
                               Add13 = g.Sum(p => p.Add13),
                               Add14 = g.Sum(p => p.Add14),
                               Add15 = g.Sum(p => p.Add15),
                               Ded01 = g.Sum(p => p.Ded01),
                               Ded02 = g.Sum(p => p.Ded02),
                               Ded03 = g.Sum(p => p.Ded03),
                               Ded04 = g.Sum(p => p.Ded04),
                               Ded05 = g.Sum(p => p.Ded05),
                               Ded06 = g.Sum(p => p.Ded06),
                               Ded07 = g.Sum(p => p.Ded07),
                               Ded08 = g.Sum(p => p.Ded08),
                               Ded09 = g.Sum(p => p.Ded09),
                               Ded10 = g.Sum(p => p.Ded10),
                               Ded11 = g.Sum(p => p.Ded11),
                               Ded12 = g.Sum(p => p.Ded12),
                               Ded13 = g.Sum(p => p.Ded13),
                               Ded14 = g.Sum(p => p.Ded14),
                               Ded15 = g.Sum(p => p.Ded15),                          
                               Net2 = g.Sum(p => p.Net)
                          }).ToList();
        ...
        public string GetSection(int? SectionCode)
        {
            ...
            return (myCode == null ? "" : myCode.Name1);
        }
        ...
        public void MakeSum()
        {
            ...
            if (grdCodes.FooterRow != null)
            {
                ...
                double Ded01 = 0, Ded02 = 0, Ded03 = 0, Ded04 = 0, Ded05 = 0, Ded06 = 0, Ded07 = 0, Ded08 = 0, Ded09 = 0, Ded10 = 0, Ded11 = 0, Ded12 = 0, Ded13 = 0, Ded14 = 0, Ded15 = 0 , Net2 = 0  ;
                foreach (Salaries itm in MyOver)
                {
                    ...
                    Net2 += (double)itm.Net2;
                }

                if (lblTotalNet != null)
                {
                    lblTotalNet.Text = string.Format("{0:N0}", Net2);
                    TotalNet = lblTotalNet.Text;
                }

                if (lblTotalDedAll != null)
                {
                    lblTotalDedAll.Text = string.Format("{0:N0}", DedAll);
                ...
                if (lblTotalDed15 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed15.Text = string.Format("{0:N0}", Ded15);
                ...
                if (lblTotalDed14 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed14.Text = string.Format("{0:N0}", Ded14);
                ...
                if (lblTotalDed13 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed13.Text = string.Format("{0:N0}", Ded13);
                ...
                if (lblTotalDed12 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed12.Text = string.Format("{0:N0}", Ded12);
                ...
                if (lblTotalDed11 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed11.Text = string.Format("{0:N0}", Ded11);
                ...
                if (lblTotalDed10 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed10.Text = string.Format("{0:N0}", Ded10);
                ...
                if (lblTotalDed09 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed09.Text = string.Format("{0:N0}", Ded09);
                ...
                if (lblTotalDed08 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed08.Text = string.Format("{0:N0}", Ded08);
                ...
                if (lblTotalDed07 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed07.Text = string.Format("{0:N0}", Ded07);
                ...
                if (lblTotalDed06 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed06.Text = string.Format("{0:N0}", Ded06);
                ...
                if (lblTotalDed05 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed05.Text = string.Format("{0:N0}", Ded05);
                ...
                if (lblTotalDed04 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed04.Text = string.Format("{0:N0}", Ded04);
                ...
                if (lblTotalDed03 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed03.Text = string.Format("{0:N0}", Ded03);
                ...
                if (lblTotalDed02 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed02.Text = string.Format("{0:N0}", Ded02);
                ...
                if (lblTotalDed01 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalDed01.Text = string.Format("{0:N0}", Ded01);
                ...
                {
                    lblTotalAddAll.Text = string.Format("{0:N0}", AddAll);
                ...
                if (lblTotalAdd15 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd15.Text = string.Format("{0:N0}", Add15);
                ...
                if (lblTotalAdd14 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd14.Text = string.Format("{0:N0}", Add14);
                ...
                if (lblTotalAdd13 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd13.Text = string.Format("{0:N0}", Add13);
                ...
                if (lblTotalAdd12 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd12.Text = string.Format("{0:N0}", Add12);
                ...
                if (lblTotalAdd11 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd11.Text = string.Format("{0:N0}", Add11);
                ...
                if (lblTotalAdd10 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd10.Text = string.Format("{0:N0}", Add10);
                ...
                if (lblTotalAdd09 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd09.Text = string.Format("{0:N0}", Add09);
                ...
                if (lblTotalAdd08 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd08.Text = string.Format("{0:N0}", Add08);
                ...
                if (lblTotalAdd07 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd07.Text = string.Format("{0:N0}", Add07);
                ...
                if (lblTotalAdd06 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd06.Text = string.Format("{0:N0}", Add06);
                ...
                if (lblTotalAdd05 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd05.Text = string.Format("{0:N0}", Add05);
                ...
                if (lblTotalAdd04 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd04.Text = string.Format("{0:N0}", Add04);
                ...
                if (lblTotalAdd03 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd03.Text = string.Format("{0:N0}", Add03);
                ...
                if (lblTotalAdd02 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd02.Text = string.Format("{0:N0}", Add02);
                ...
                if (lblTotalAdd01 != null)
                {
                    ...
                    else
                    {
                        ...
                        lblTotalAdd01.Text = string.Format("{0:N0}", Add01);
                ...
                {
                    lblTotalBasic.Text = string.Format("{0:N0}", Basic);
        ...
        protected void BtnPrint1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                var cols = new[] { 1300 };
                if (ColCount == 36) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 35) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 34) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 33) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 32) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 31) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 30) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 29) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 28) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 27) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 26) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 25) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 24) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 23) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 22) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 21) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 20) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 19) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 18) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 17) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 16) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 15) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 14) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 13) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 12) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 11) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 10) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 9) cols = new[] { 50, 60, 50, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 8) cols = new[] { 50, 60, 50, 50, 50, 50, 110, 25 };
                else if (ColCount == 7) cols = new[] { 50, 60, 50, 50, 50, 110, 25 };
                ...
                foreach (Salaries itm in MyOver)
                {
                    ...
                    if (page.Add03)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add03), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add04)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add04), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add05)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add05), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add06)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add06), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add07)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add07), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add08)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add08), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add09)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add09), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add10)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add10), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add11)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add11), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add12)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add12), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add13)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add13), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add14)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add14), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Add15)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Add15), nationalTextFont);
                        table.AddCell(cell);
                    }

                    cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.AddAll), nationalTextFont);
                    table.AddCell(cell);

                    if (page.Ded01)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded01), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded02)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded02), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded03)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded03), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded04)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded04), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded05)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded05), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded06)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded06), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded07)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded07), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded08)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded08), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded09)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded09), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded10)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded10), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded11)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded11), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded12)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded12), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded13)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded13), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded14)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded14), nationalTextFont);
                        table.AddCell(cell);
                    }

                    if (page.Ded15)
                    {
                        cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Ded15), nationalTextFont);
                        table.AddCell(cell);
                    }

                    cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.DedAll), nationalTextFont);
                    table.AddCell(cell);

                    cell.Phrase = new iTextSharp.text.Phrase(string.Format("{0:N0}", itm.Net2), nationalTextFont);
                    table.AddCell(cell);
                }
                ...
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd03, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd04) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd04, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd05) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd05, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd06) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd06, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd07) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd07, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd08) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd08, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd09) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd09, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd10) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd10, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd11) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd11, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd12) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd12, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd13) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd13, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd14) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd14, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalAdd15) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalAdd15, nationalTextFont);
                    table.AddCell(cell);
                }

                cell.Phrase = new iTextSharp.text.Phrase(TotalAddAll, nationalTextFont);
                table.AddCell(cell);

                if (moh.StrToDouble(TotalDed01) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed01, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed02) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed02, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed03) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed03, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed04) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed04, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed05) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed05, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed06) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed06, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed07) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed07, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed08) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed08, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed09) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed09, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed10) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed10, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed11) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed11, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed12) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed12, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed13) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed13, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed14) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed14, nationalTextFont);
                    table.AddCell(cell);
                }

                if (moh.StrToDouble(TotalDed15) != 0)
                {
                    cell.Phrase = new iTextSharp.text.Phrase(TotalDed15, nationalTextFont);
                    table.AddCell(cell);
                }

                cell.Phrase = new iTextSharp.text.Phrase(TotalDedAll, nationalTextFont);
                table.AddCell(cell);
                ...
                cell.Phrase = new iTextSharp.text.Phrase("مبلغ وقدرة " + moh.NTOC(moh.StrToDouble(TotalNet), 1), nationalTextFont);
                table.AddCell(cell);
                ...
                var cols5 = new[] { 75, 200, 200, 200, 200, 200, 70 };
        ...
        public class pdfPage : iTextSharp.text.pdf.PdfPageEventHelper
        {
            ...
            public override void OnStartPage(PdfWriter writer, iTextSharp.text.Document doc)
            {
                ...
                //cell2.PaddingRight = 0;
                cell2.Phrase = new iTextSharp.text.Phrase("كشف اجماليات الرواتب " + vStr1, nationalTextFont);
                cell2.HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER;
                cell2.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                headerTbl.AddCell(cell2);

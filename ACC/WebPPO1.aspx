                                    ...
                                    <asp:GridView ID="grdCodes" runat="server" CellPadding="4" ForeColor="#333333" ShowFooter="True"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="الحاله" SortExpression="Approved" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlApproved" SelectedValue='<%# Bind("Approved") %>' Enabled="false" AutoPostBack="true" runat="server" onselectedindexchanged="ddlApproved_SelectedIndexChanged">

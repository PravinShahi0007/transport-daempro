...
namespace ACC
{
    public partial class WebNotPaidInvRep : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    this.Page.Header.Title = "فواتير لم يتم تحصيلها";
                    ...
                    */
                    ...
                    ddlSite.Enabled = (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass471;
                    ChkSite.Enabled = (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass471;
        ...
        protected void ddlBranch_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ddlSite.DataSource = myInv.NotPaidGetSite(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
                ddlSite.DataBind();
        ...
        protected void BtnPrint1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                {
                    cell2.Phrase = new iTextSharp.text.Phrase(" فواتير لم يتم تحصيلها عن جميع الفترات ", nationalTextFont16);
                }
                else
                {
                    cell2.Phrase = new iTextSharp.text.Phrase(" فواتير لم يتم تحصيلها عن الفترة من  " +  txtFDate.Text + " إلى " + txtEDate.Text, nationalTextFont16);
                }
                table.AddCell(cell2);
        ...
        protected void BtnProcess_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                MyOver = myInv.NotPaidGetAll2(txtFDate.Text, txtEDate.Text,ChkRcv.Checked ,WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
                LoadCodesData();
            }
            catch (Exception ex)
            {

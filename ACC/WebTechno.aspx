                         ...
                         <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <asp:Label ID="LblCodesResult" runat="server" ForeColor="#FF0066"></asp:Label>
                                ...
                                <asp:ImageButton ID="BtnNew" runat="server" AlternateText="جديد" CommandName="New"
                                    ImageUrl="~/images/data add.png" CssClass="ops" ToolTip="<%$ Resources:AddTechToolTip %>"
                                    ValidationGroup="1" OnClientClick='<%$ Resources:AddTechConfirm %>'
                                    OnClick="BtnNew_Click" />
                                <asp:ImageButton ID="BtnEdit" runat="server" AlternateText="تعديل" CommandName="Edit"
                                    ImageUrl="~/images/edit2.png" CssClass="ops" ToolTip="<%$ Resources:EditTechToolTip %>"
                                    Width="64px" ValidationGroup="1" OnClick="BtnEdit_Click" />
                                <asp:ImageButton ID="BtnClear" runat="server" AlternateText="مسح" CommandName="Clear"
                                    ImageUrl="~/images/clear all.png" CssClass="ops" ToolTip="<%$ Resources:ClearTechToolTip %>"
                                    OnClick="BtnClear_Click" />
                                <asp:ImageButton ID="BtnDelete" runat="server" AlternateText="إلغاء" CommandName="Delete"
                                    ImageUrl="~/images/delete2.png" CssClass="ops" ToolTip="<%$ Resources:DeleteTechToolTip %>" OnClientClick='<%$ Resources:DeleteTechConfirm %>'

        ...
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99.8%;
                ...
                <asp:GridView ID="grdCodes" runat="server" CellPadding="4" ForeColor="#333333"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="الطول" SortExpression="Height" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtHeight" Text='<%# Bind("Height") %>'  MaxLength="11" runat="server"></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="العرض" SortExpression="Width" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtWidth" Text='<%# Bind("Width") %>' MaxLength="11" runat="server"></asp:TextBox>
                                </ItemTemplate>
                                <ControlStyle Width="60px"></ControlStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="الوزن" SortExpression="Weight" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtWeight" Text='<%# Bind("Weight") %>' MaxLength="11" runat="server"></asp:TextBox>
                                </ItemTemplate>
                                <ControlStyle Width="60px"></ControlStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="السعر" SortExpression="SPrice" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtSPrice" Text='<%# Bind("SPrice") %>' MaxLength="10" runat="server"></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="الكمية" SortExpression="Qty" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtQty" Text='<%# Bind("Qty") %>' MaxLength="11" runat="server"></asp:TextBox>
                                </ItemTemplate>
                                <ControlStyle Width="60px"></ControlStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
            ...
            <div id="Divsingle" runat="server">
                <table width="99%" cellpadding="5px" dir="rtl">
                    <tr>
                        <td style="width: 150px;">
                            <asp:Label ID="lblAccess4" runat="server"  Visible="false"  Text="نوع الشحنة"></asp:Label>
                        </td>
                        <td style="width: 300px;" colspan="2">
                        ...
                        <td style="width: 300px; margin-right: 40px;" colspan="2">
                            <asp:DropDownList ID="ddlUnit" runat="server" Style="width: 120px" AutoPostBack="true" Visible="false"
                    ...
                    <tr>
                        ...
                        <td style="width: 300px;" colspan="2">
                            <asp:DropDownList ID="ddlCoverSize" runat="server" Style="width: 120px" Visible="false" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlUnit_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <td style="width: 300px;" colspan="2">
                            <asp:TextBox ID="txtQty" MaxLength="10" Visible="false" runat="server"></asp:TextBox>
                        ...
                        <td style="width: 300px;" colspan="2">
                            <asp:TextBox ID="txtWeight" Text="" MaxLength="11" Visible="false" runat="server" AutoPostBack="True"
                    ...
                    <tr>
                        ...
                        <td style="width: 300px;" colspan="2">
                            <asp:TextBox ID="txtPrice" Text="" MaxLength="15" Visible="false" runat="server" AutoPostBack="True"
                        ...
                        <td style="width: 300px;" colspan="2">
                            <asp:DropDownList ID="ddlUse" runat="server" Visible="false"  >
                    ...
                    <tr>
                        ...
                        <td style="width: 300px;" colspan="2">
                            <asp:TextBox ID="txtQty2" Text="1" MaxLength="15" AutoPostBack="True" OnTextChanged="txtQty2_TextChanged"

...
function CalendarsPicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		weekText: 'أسبوع', // Text for week of the year column header
...
$.extend(CalendarsPicker.prototype, {
	...
	commands: { // Command actions that may be added to a layout by name
		...
		// tdy: {text: 'tdyText', status: 'tdyStatus', // Today's month
			// keystroke: {keyCode: 32, ctrlKey: true}, // Ctrl + Home
			// enabled: function(inst) {alert("جميع الحقوق محفوظة<br>فلاح الشمري.");},
			// date: function(inst) { alert("جميع الحقوق محفوظة<br>فلاح الشمري."); },
			// action: function(inst) { alert("جميع الحقوق محفوظة<br>فلاح الشمري."); }
		// },

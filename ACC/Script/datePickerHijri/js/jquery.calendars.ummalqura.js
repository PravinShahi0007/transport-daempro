...
$.extend(UmmAlQuraCalendar.prototype, {
	...
	regional: { // Localisations
		'': {
			...
			epochs: ['BH', 'AH'],
			monthNames: ['محرم', 'صفر', 'ربيع الأولى', 'ربيع الثاني', 'جمادى الأولى', 'جمادى الثاني',
			'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
			monthNamesShort: ['محر', 'صفر', 'ربيع1', 'ربيع2', 'جماد1', 'جماد2', 'رجب', 'شعب', 'رمض', 'شوا', 'ذوق', 'ذوج'],
			dayNames: ['الأحد', 'الأثنين', 'الثلاثاء', 'الأربعاء’', 'الخميس', 'الجمعة', 'السبت'],
			dayNamesMin: ['أح', 'أث', 'ث', 'أر', 'خ', 'ج', 'س'],

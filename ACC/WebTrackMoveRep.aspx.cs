...
namespace ACC
{
    public partial class WebTrackMoveRep : System.Web.UI.Page
    {
        ...
        protected override void InitializeCulture()
        {
            ...
            //newCulture.NumberFormat.NumberNegativePattern = 0;
            //newCulture.NumberFormat.CurrencyNegativePattern = 0;
            //System.Threading.Thread.CurrentThread.CurrentCulture = newCulture; base.InitializeCulture();
        }
        ...
        protected void BtnProcess_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                foreach(TrackMove itm in MyOver)
                {

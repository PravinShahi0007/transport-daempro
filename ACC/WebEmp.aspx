...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-md-12  col-sm-12 col-xs-12">
        <div class="card card-body">
            ...
            <h3 align="center">[ البيانات الإساسية ]</h3>
                ...
                <div class="body">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtEmpCode" CssClass="form-control" runat="server" MaxLength="50" EnableViewState="false"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:Button ID="BtnLoad0" CssClass="btn btn-primary" runat="server" Text="تحميل الصورة" OnClick="BtnLoad0_Click" />
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtJobNo" CssClass="form-control" runat="server" MaxLength="20"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtName2" CssClass="form-control" runat="server" autocomplete="off" MaxLength="100"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:DropDownList ID="ddlDep" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:DropDownList ID="ddlReginal" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtBirthDate" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:DropDownList ID="ddlBirthPlace" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtEnterVisaNo" CssClass="form-control" runat="server" MaxLength="20"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtVisaPlace" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtEnterVisaNo2" CssClass="form-control" runat="server" MaxLength="20"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtEnterVisaDate2" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtEnterVisaDate" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtIqamaEnd" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtWorkerNo" CssClass="form-control" runat="server" MaxLength="20"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtOffice" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtOfficeManager" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtOfficeMobile" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtJoinDate" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtVacDate" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtReturnDate" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtEndDate" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtTicketNo" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtVacDays" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtVacRemain" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtTicketValue" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtOffDays" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtATM" CssClass="form-control" runat="server" MaxLength="20"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:DropDownList ID="ddlUserName2" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:DropDownList ID="ddlManag1" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:DropDownList ID="ddlManag2" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtamP10" CssClass="form-control" Placeholder="القيمة" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtMP10" CssClass="form-control" Placeholder="عدد الشهور" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtP10LDate" CssClass="form-control" Placeholder="أخر تنفيذ" runat="server" MaxLength="20"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtamP11" CssClass="form-control" Placeholder="القيمة" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtMP11" CssClass="form-control" Placeholder="عدد الشهور" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtP11LDate" CssClass="form-control" Placeholder="أخر تنفيذ" runat="server" MaxLength="20"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtamP12" CssClass="form-control" Placeholder="القيمة" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtMP12" CssClass="form-control" Placeholder="عدد الشهور" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtP12LDate" CssClass="form-control" Placeholder="أخر تنفيذ" runat="server" MaxLength="20"></asp:TextBox>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <asp:TextBox ID="txtamP13" CssClass="form-control" Placسeholder="القيمة" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtMP13" CssClass="form-control" Placeholder="عدد الشهور" runat="server" MaxLength="20"></asp:TextBox>
                                    <asp:TextBox ID="txtP13LDate" CssClass="form-control" Placeholder="أخر تنفيذ" runat="server" MaxLength="20"></asp:TextBox>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <asp:Label ID="Label6" runat="server" Text="الوثائق الشخصية"></asp:Label>
                                ...
                                <div class="card-body" style="display: none;">
                                    <asp:Panel ID="Panel4" runat="server">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo1" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:DropDownList ID="ddlPaperLoc1" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:TextBox ID="txtIssueDate1" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="txtIssueDate1"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate1" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo2" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:DropDownList ID="ddlPaperLoc2" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:TextBox ID="txtIssueDate2" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator29" runat="server" ControlToValidate="txtIssueDate2"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate2" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo3" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:DropDownList ID="ddlPaperLoc3" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:TextBox ID="txtIssueDate3" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:TextBox ID="txtExpDate3" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo4" CssClass="form-control" MaxLength="20" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:DropDownList ID="ddlPaperLoc4" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate4" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:TextBox ID="txtExpDate4" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo5" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:DropDownList ID="ddlPaperLoc5" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate5" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator32" runat="server" ControlToValidate="txtIssueDate5"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate5" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <asp:Label ID="lblPaper6" runat="server" CssClass="form-control" Text="حساب بنكي"></asp:Label>

                                                    <asp:TextBox ID="txtPaperNo6" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>

                                                    <asp:DropDownList ID="ddlPaperLoc6" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate6" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator33" runat="server" ControlToValidate="txtIssueDate6"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate6" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo7" MaxLength="20" runat="server" CssClass="form-control"> </asp:TextBox>

                                                    <asp:DropDownList ID="ddlPaperLoc7" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate7" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator34" runat="server" ControlToValidate="txtIssueDate7"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate7" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo8" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>

                                                    <asp:DropDownList ID="ddlPaperLoc8" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate8" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator35" runat="server" ControlToValidate="txtIssueDate8"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate8" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:Label ID="lblPaper9" runat="server" CssClass="form-control" Text="رخصة قيادة"></asp:Label>

                                                    <asp:TextBox ID="txtPaperNo9" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>

                                                    <asp:DropDownList ID="ddlPaperLoc9" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate9" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator36" runat="server" ControlToValidate="txtIssueDate9"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate9" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <asp:TextBox ID="txtPaperNo10" MaxLength="20" runat="server" CssClass="form-control"></asp:TextBox>

                                                    <asp:DropDownList ID="ddlPaperLoc10" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>

                                                    <asp:TextBox ID="txtIssueDate10" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:CompareValidator ID="CompareValidator37" runat="server" ControlToValidate="txtIssueDate10"
                                                        CultureInvariantValues="true" ErrorMessage="يجب أن تكون القيمة تاريخ" ForeColor="Red"
                                                        Type="Date" ValidationGroup="1" Display="Dynamic" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>

                                                    <asp:TextBox ID="txtExpDate10" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <asp:Label ID="Label35" runat="server" Text="بيانات المرتب"></asp:Label>
                                ...
                                <div class="card-body table-responsive" style="display: none;">
                                        <table id="box-table-a1" width="100%" class="table table-hover text-center" cellpadding="2px" cellspacing="5px" style="color: Black">
                                            <thead>
                                                <tr>
                                                    <th scope="col" colspan="2">الاستحقاقات
                                                    </th>
                                                    <th scope="col" colspan="2">الاستقطاعات
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr id="tr34" align="right">
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtBasic" CssClass="form-control" runat="server" MaxLength="50" AutoPostBack="True" OnTextChanged="txtBasic_TextChanged"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed01" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr35" align="right">
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtAdd01" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed02" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr36" align="right">
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtAdd02" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed04" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr37" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd03" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed03" CssClass="form-control" runat="server" ReadOnly="true" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr38" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd04" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed05" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr39" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd05" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed06" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr40" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd06" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed07" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr41" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd07" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed08" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr42" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd08" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px">
                                                        <asp:TextBox ID="txtDed09" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr43" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd09" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px;">
                                                        <asp:TextBox ID="txtDed10" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr10" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd10" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px;">
                                                        <asp:TextBox ID="txtDed11" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr11" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd11" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px;">
                                                        <asp:TextBox ID="txtDed12" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr12" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd12" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px;">
                                                        <asp:TextBox ID="txtDed13" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr15" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd13" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px;">
                                                        <asp:TextBox ID="txtDed14" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr16" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd14" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <td style="width: 200px;">
                                                        <asp:TextBox ID="txtDed15" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                ...
                                                <tr id="tr57" align="right">
                                                    ...
                                                    <td style="width: 250px">
                                                        <asp:TextBox ID="txtAdd15" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                            ...
                            <tr align="center">
                                ...
                                <td style="width: 400px;">
                                    ...
                                    <asp:ImageButton ID="BtnSearch" runat="server" AlternateText="بحث" CommandName="Find"
                                        ImageUrl="~/images/data search.png" ToolTip="البحث عن بيانات معاملة" OnClick="BtnSearch_Click" />
                                </td>
   ...
   <br />                     
                        ...
                        <div id="mdiv3" runat="server" class="table-responsive">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td align="center" style="width: 195px">
                                        <b>
                                            <asp:Label ID="Label59" ForeColor="#800000" Font-Underline="true" runat="server" Text="[ أرشيف المعاملات ]" meta:resourcekey="Label1"></asp:Label></b>
                                    </td>
                                    <td style="width: 50px">
    ...
    <center dir="rtl">
        <div class="ColorRounded4Corners">
            <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;">
                <legend align="right" style="font-size: 18px; color: #800000; text-align: center;"><b>[ البيانات الإساسية ]</b></legend>
                <center>

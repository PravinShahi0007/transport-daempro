...
<div class="Round4Courner" style="width: 98%">
            <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 98%;
                ...
                <center>
                    <br />
                     <!-- edited by hanan10 : all the page -->  
                    <table dir="rtl" width="99%" cellpadding="2px">
                        ...
                        <tr align="right">
                            ...
                            <td style="width: 300px;">
                                <asp:DropDownList ID="ddldetail" Width="150px" runat="server" 
                            ...
                            <td style="width: 300px;">
                                <asp:DropDownList ID="ddlcount" Width="150px" runat="server" AutoPostBack="True" 
                         ...
                         <tr align="right">
                          ...
                          <!-- edited by hanan10 : from here -->  
                            ...
                            <td style="width: 300px;">
                                    ...
                                    <asp:TextBox ID="txtprice2" Width="60px" runat="server" 

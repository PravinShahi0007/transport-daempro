<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true"
    CodeBehind="WebVac2.aspx.cs" Inherits="ACC.WebVac2" Culture="auto:ar-EG" UICulture="auto"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ColorRounded4Corners" style="width: 99.9%" dir="rtl">
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99.8%;
            ...
            <legend align="right" style="font-size: 18px; color: #800000; text-align: center;">طلب
                أجازة</legend>
            <center>
                <table width="99.5%">
                    <tr>
                    ...
                    <tr>
                        <td align="right" style="width: 100px;">
                            <asp:Label ID="Label6" runat="server" Text="نوع الأجازة*"></asp:Label>
                        </td>
                        <td align="right" style="width: 300px;">
                            <asp:DropDownList ID="ddlFType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="txtSDate_TextChanged">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlFType"
                                Display="Dynamic" ErrorMessage="يجب أختيار نوع الأجازة" ForeColor="Red" SetFocusOnError="True"
                                InitialValue="-1" ValidationGroup="1">*</asp:RequiredFieldValidator>
                        </td>
                        <td align="right" style="width: 100px;">
                            <asp:Label ID="Label7" runat="server" Text="عدد ايام الاجازة*"></asp:Label>
                        </td>
                        <td align="right" style="width: 300px;">
                            <asp:TextBox ID="txtVacDays" MaxLength="10" runat="server" Width="100px" ReadOnly="true"
                                CssClass="MouseStop"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 100px;">
                            <asp:Label ID="Label31" runat="server" Text="تبدأ من*"></asp:Label>
                        </td>
                        <td align="right" style="width: 300px;">
                            <asp:TextBox ID="txtSDate" Width="100px" MaxLength="10" runat="server" AutoPostBack="True"
                                OnTextChanged="txtSDate_TextChanged"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSDate"
                                Display="Dynamic" ErrorMessage="يجب أختيار تاريخ بداية الاجازة" ForeColor="Red"
                        ...
                        <td align="right" style="width: 100px;">
                            <asp:Label ID="Label32" runat="server" Text="تنتهي في"></asp:Label>
                        </td>
                        <td align="right" style="width: 300px;">
                            <asp:TextBox ID="txtEDate" Width="100px" MaxLength="10" runat="server" AutoPostBack="True"
                                OnTextChanged="txtSDate_TextChanged"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtEDate"
                                Display="Dynamic" ErrorMessage="يجب أختيار تاريخ نهاية الاجازة" ForeColor="Red"
                                SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtEDate"
                                CultureInvariantValues="true" Display="Dynamic" ErrorMessage="يجب أن تكون القيمة تاريخ"
                                ForeColor="Red" Type="Date" ValidationGroup="1" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>
                    ...
                    <tr>
                        <td align="right" style="width: 100px;">
                            <asp:Label ID="Label8" runat="server" Text="ملاحظات"></asp:Label>
                        </td>
                ...
                <br />
                <div id="VacDetails" runat="server" width="100%" visible="false">
                    <table width="99.5%">
                        <tr>
                        ...
                        <tr>
                            <td align="right" style="width: 150px;">
                                <asp:Label ID="Label39" runat="server" Text="الاساسي"></asp:Label>
                            </td>
                            <td align="right" style="width: 250px;">
                                <asp:TextBox ID="txt_Basic" MaxLength="10" runat="server" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td align="right" style="width: 150px;">
                                <asp:Label ID="Label40" runat="server" Text="بدل السكن"></asp:Label>
                            </td>
                            <td align="right" style="width: 250px;">
                                <asp:TextBox ID="txt_Add02" ReadOnly="true" MaxLength="10" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 150px;">
                                <asp:Label ID="Label41" runat="server" Text="بدل الاجازة"></asp:Label>
                            </td>
                            <td align="right" style="width: 250px;">
                                <asp:TextBox ID="txtTotVac" MaxLength="10" runat="server" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td align="right" style="width: 150px;">
                                <asp:Label ID="Label42" runat="server" Text="حسميات أخرى"></asp:Label>
                            </td>
                            <td align="right" style="width: 250px;">
                                <asp:TextBox ID="txt_Ded" MaxLength="10" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 150px;">
                                <asp:Label ID="Label43" runat="server" Text="قيمة الاجازة"></asp:Label>
                            </td>
                            <td align="right" style="width: 250px;">
                                <asp:TextBox ID="txtVacam" MaxLength="10" runat="server" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td align="right" style="width: 150px;">
                                <asp:Label ID="Label38" runat="server" Text="قيمة التذاكر"></asp:Label>
                            </td>
                            <td align="right" style="width: 250px;">
                                <asp:TextBox ID="txtTicketam" ReadOnly="true" MaxLength="10" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <table id="box-table-a" width="98%" cellpadding="2px" cellspacing="5px" style="color: Black">
                        <thead>
                            <tr>
                                <th scope="col" colspan="2" align="center" class="mytd">
                                    الاستحقاقات
                                </th>
                                <th scope="col" align="center" class="mytd">
                                    المبلغ
                                </th>
                                <th scope="col" colspan="2" align="center" class="mytd">
                                    مده العمل للإجازة
                        ...
                        <tbody>
                            <tr id="tr15" align="right">
                                ...
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtBasic" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="Label10" runat="server" Text="تاريخ أخر اجازة"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtVacDate" Width="100px" MaxLength="10" runat="server" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr16" align="right">
                                ...
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd02" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="Label33" runat="server" Text="تاريخ أخر مباشرة"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtReturnDate" Width="100px" ReadOnly="true" MaxLength="10" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr17" align="right">
                                ...
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd01" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="Label35" runat="server" Text="مدة العمل المستحقة"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtVacDays2" Width="100px" MaxLength="10" runat="server" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr18" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd03" runat="server" Text="بدل طبيعة عمل"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd03" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="Label44" runat="server" Text="ايام مستقطعه من مده العمل"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtDedDays" Width="100px" runat="server" MaxLength="50"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr19" align="right">
                                ...
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd04" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="Label45" runat="server" Text="صافي مدة العمل للإجازة"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtVacDays22" Width="100px" ReadOnly="true" MaxLength="10" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr22" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd05" runat="server" Text="تأمينات مخاطر"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd05" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="Label36" runat="server" Text="عدد أيام الاجازة المستحقة"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtVac" Width="100px" ReadOnly="true" MaxLength="10" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr31" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd06" runat="server" Text="تأمينات تعطل عن العمل"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd06" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="lblDed11" runat="server" Text="أستقطاع 6"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtDed11" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr32" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd07" runat="server" Text="تأمينات معاشات"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd07" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="lblDed12" runat="server" Text="أستقطاع 6"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtDed12" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr34" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd15" runat="server" Text="مستحق الراتب عن الإجازة"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd15" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="lblDed13" runat="server" Text="أستقطاع 6"></asp:Label>
                                </td>
                                <td style="width: 120px;">
                                    <asp:TextBox ID="txtDed13" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr33" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd08" runat="server" Text="مستحق السكن عن الإجازة"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd08" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="lblDed14" runat="server" Text="أستقطاع 6"></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtDed14" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr5" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd12" runat="server" Text="بدل تذاكر للإجازة"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd12" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                    <asp:Label ID="lblDed15" runat="server" Text="أستقطاع 6"></asp:Label>
                                </td>
                                <td style="width: 120px;">
                                    <asp:TextBox ID="txtDed15" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr6" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd13" runat="server" Text="أخرى - تحدد"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                    <asp:TextBox ID="txtOther" Width="200px" runat="server" MaxLength="50"></asp:TextBox>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd13" Width="100px" runat="server" MaxLength="50"></asp:TextBox>
                                ...
                                <td style="width: 120px;">
                                    <asp:TextBox ID="txtDed07" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr1" align="right">
                                <td style="width: 160px;" class="mytd">
                                ...
                                <td style="width: 170px;">
                                    <asp:Label ID="Label47" runat="server" Text="أستقطاع 3"></asp:Label>
                                </td>
                                <td style="width: 120px;">
                                    <asp:TextBox ID="TextBox3" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <thead>
                                <tr>
                                    <th scope="col" colspan="3" align="center" class="mytd">
                                        الحسميات
                                    </th>
                            ...
                            <tr id="tr7" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd14" runat="server" Text="عهدة وذمم عاملين"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                    <asp:TextBox ID="txtsAdd14" MaxLength="50" Width="100px" ReadOnly="true" runat="server"></asp:TextBox>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd14" Width="100px" runat="server" MaxLength="50"></asp:TextBox>
                            ...
                            <tr id="tr10" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd09" runat="server" Text="تامينات مخاطر"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="txtAdd09" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                </td>
                                <td style="width: 120px;">
                            ...
                            <tr id="tr11" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd10" runat="server" Text="تامينات تعطل عن العمل"></asp:Label>
                                </td>
                                <td style="width: 200px">
                                </td>
                                <td style="width: 120px;">
                                    <asp:TextBox ID="txtAdd10" Width="100px" runat="server" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 170px;">
                                </td>
                                <td style="width: 120px;">
                            ...
                            <tr id="tr14" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="lblAdd11" runat="server" Text="تأمينات معاشات" Visible="False"></asp:Label>
                                </td>
                                <td style="width: 200px">
                                </td>
                                <td style="width: 120px;">
                                    <asp:TextBox ID="txtAdd11" Width="100px" runat="server" Visible="False" MaxLength="50"
                            ...
                            <tr id="tr2" align="right">
                                <td style="width: 160px;">
                                    <asp:Label ID="Label37" runat="server" Text="أخرى - تحدد"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                                    <asp:TextBox ID="TextBox1" Width="200px" runat="server" MaxLength="50"></asp:TextBox>
                                </td>
                                <td style="width: 120px">
                                    <asp:TextBox ID="TextBox2" Width="100px" runat="server" MaxLength="50"></asp:TextBox>
                                    <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtAdd13"
                                        Display="Dynamic" ErrorMessage="يجب أن تكون القيمة رقمية" ForeColor="Red" Type="Currency"
                                        ValidationGroup="1" SetFocusOnError="True" Operator="DataTypeCheck">*</asp:CompareValidator>
                                </td>
                                <td style="width: 170px;">
                            ...
                            <tr id="tr8" align="right">
                                <td class="mytd" style="width: 160px;">
                            ...
                            <tr id="tr9" align="right">
                                <td style="width: 160px;" class="mytd">
                                    <asp:Label ID="lblNet" runat="server" Text="صافي المستحقات" Style="font-weight: 700"></asp:Label>
                                </td>
                                <td style="width: 200px;">
                        ...
                        <asp:Panel ID="PAgree11" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                <table width="99.5%">
                                    <tr>
                                        <td align="right" style="width: 100px;">
                                            <asp:Label ID="lblDaysOff1" runat="server" Text="أيام الانقطاع"></asp:Label>
                                        </td>
                                        <td align="right" style="width: 300px;">
                                            <asp:TextBox ID="txtDaysOff1" runat="server" ReadOnly="false"></asp:TextBox>
                                        </td>
                                        <td align="right" style="width: 100px;">
                                            <asp:Label ID="lblDiscount1" runat="server" Text="الخصم"></asp:Label>
                                        </td>
                                        <td align="right" style="width: 300px;">
                                            <asp:TextBox ID="txtDiscount1" runat="server" ReadOnly="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" style="width: 100px;">
                    ...
                    <div id="divAgree2" visible="false" runat="server" width="99.8%">
                        ...
                        <asp:Panel ID="PAgree21" runat="server" Height="0" BackColor="#FFFFEC" class="Round4Courner"
                            ...
                            <div style="width: 100%; overflow: none; overflow-x: auto; border: 1px solid #800000;">
                                ...
                                <div id="DivRule2" runat="server" visible="false" style="text-align: right; padding-right: 25px;">
                                    <asp:Label ID="Label30" runat="server" Text="عند الموافقة على الطلب سيتم تلقائياً الأجراءات التالية:"
                                        ForeColor="#0033CC" Font-Underline="True"></asp:Label>
                                    <asp:BulletedList ID="bstRules" runat="server">
                                        <asp:ListItem Text="تفعيل حساب الموظف على النظام - في حالة وجود حساب له على النظام"></asp:ListItem>
                                        <asp:ListItem Text="تحديث تاريخ المباشرة في ملف البيانات الأساسية للموظف"></asp:ListItem>
                                        <asp:ListItem Text="أرسال رسالة أو ايميل للموظف توضح له الموافقة على الطلب"></asp:ListItem>
                                    </asp:BulletedList>
                                </div>
                                <br />

                        ...
                        <asp:GridView ID="grdCodes" runat="server" CellPadding="4" Width="99.95%" ForeColor="#333333"
                            ...
                            <Columns>
                                    ...
                                    <FooterTemplate>
                                        <asp:ImageButton ID="btnInsert" runat="server" CommandName="Insert" ToolTip="Add New Item"
                                            ...
                                            <asp:TemplateField HeaderText="Status" SortExpression="Approved"  ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlApproved" SelectedValue='<%# Bind("Approved") %>' AutoPostBack="true" Enabled="false" runat="server"  onselectedindexchanged="ddlApproved_SelectedIndexChanged">
                                ...
                                <asp:TemplateField HeaderText="Part No." SortExpression="ITCode" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <FooterTemplate>
                                            <asp:TextBox ID="txtITCode2" runat="server" Placeholder="Item Code" Width="100px" autocomplete="off" />
                                            ...
                                            <asp:TextBox ID="txtITCode0" Placeholder="Part No" runat="server" Width="100px" autocomplete="off" />
                                ...
                                <asp:TemplateField HeaderText="Part Name" SortExpression="ITName2" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtITName" Text='<%# Bind("ITName2") %>' autocomplete="off" runat="server" Width="250px" />
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtITName2" runat="server" Width="250px" autocomplete="off" />
                                ...
                                <asp:TemplateField HeaderText="Unit" SortExpression="Unitname2" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlUnit" EnableViewState="false"  OnInit="ddlUnit2_Init" Width="100px" runat="server">
                                        </asp:DropDownList>
                                    </EditItemTemplate>
                                    <FooterTemplate>
                                        <asp:DropDownList ID="ddlUnit2" Width="100px" runat="server" OnInit="ddlUnit2_Init">
                                        </asp:DropDownList>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="100px"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Qty" SortExpression="Quan" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtQuan" Text='<%# bind("Quan") %>' Width="100px" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <FooterTemplate>
                        ...
                        <tr align="center">
                            <td colspan="4" style="width: 100%;">
                                ...
                                <asp:ImageButton ID="BtnEdit" runat="server" AlternateText="Edit" CommandName="Edit"
                                    ImageUrl="~/images/draw_pen_641.png" CssClass="ops" ToolTip="Edit Request" Width="64px"

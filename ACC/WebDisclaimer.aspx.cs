...
namespace ACC
{
    public partial class WebDisclaimer : System.Web.UI.Page
    {
        public string DocType = "301";
        public string DocName = "إخلاء طرف موظف";
        ...
        {
            if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1") moh.AddUserTrans(Session["CurrentUser"].ToString(), "طلب إخلاء طرف", "طباعة", "طباعة طلب إخلاء طرف رقم " + Number, "", IPNetworking.GetIP4Address(), WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
        ...
        {
            if (ddlFType.SelectedValue == "0")
            {
                txtNotes2.Visible = false;
                RequiredFieldValidator6.Visible = false;
                RequiredFieldValidator6.Enabled = false;
                Label32.Text = "تاريخ أنهاء العقد";

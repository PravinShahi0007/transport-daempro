...
namespace ACC
{
    public partial class WebPPO : System.Web.UI.Page
    {
        ...
        public void EditMode()
        {
            ...
            BtnDelete.Visible = true && (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass233;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    lblBranch2.Text = "/" + (FType == 5 ? "01" : FType == 3 ? "00" + short.Parse(vAreaNo).ToString() : short.Parse(vAreaNo).ToString());
                    lblBranch2.Visible = (vAreaNo != "00000");

                    TblUsers ax = new TblUsers();
                    if (Cache["Users" + Session["CNN2"].ToString()] == null) Cache.Insert("Users" + Session["CNN2"].ToString(), ax.GetAll(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString));
                    vRoleName = moh.GetCurrentRole(vAreaNo != "00000" ? vAreaNo == "1" ? Request.QueryString["AreaNo"].ToString() : vAreaNo : "00001", (from useritm in (List<TblUsers>)(Cache["Users" + Session["CNN2"].ToString()])
        ...
        protected void LoadVouData()
        {
            try
            {
                ...
                {
                    if (Request.QueryString["FMode"] != null && (bool)((List<TblRoles>)(Session[vRoleName]))[0].Pass342)
                    {
                        ...
                        for (int i = 0; i < grdCodes.Rows.Count; i++)
                        {
                            ...
                            if (ddlApproved2 != null) ddlApproved2.Enabled = true;
                        }
                    }
                }
            }
                ...
                if (Page.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        if (inv.Delete(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            UserTran.Description = "الغاء بيانات طلب شراء مواد رقم " + txtVouNo.Text;
        ...
        protected void BtnPrint_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    if (vAreaNo != "00000")
                    {
                        if(FType == 3) page.vStr3 = "الورشة المركزية";
                        else if (FType == 5) page.vStr3 = "الشئون الإدارية";
        ...
        protected void grdAttach_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                myArch.LocNumber = short.Parse(vAreaNo);
                myArch.Number = int.Parse(txtVouNo.Text);
                myArch.DocType = (FType == 5 ? 512 : FType == 3 ? 513 : 502);
            ...
            try
            {
                ...
                foreach (MyPO itm in VouData)
                {
                    ...
                    if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                    {
                        ...
                        UserTran.Description = ddlApproved2.SelectedItem.Text + "على بند طلب شراء مواد رقم " + lblBranch2.Text + "/" + txtVouNo.Text + "-" + myPo.FNo.ToString();
                        UserTran.IP = IPNetworking.GetIP4Address();
                        UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                    }

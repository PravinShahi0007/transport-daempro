...
<div class="ColorRounded4Corners" style="width: 99.9%">
        <fieldset class="Rounded4CornersNoShadow" style="padding: 2px; margin: 2px; width: 99.8%;
            ...
            <legend align="right" style="font-size: 18px; color: #800000; text-align: center;">عرض سعر</legend>
            <table width="99%" cellpadding="5px" dir="rtl">
                ...
                <tr>
                    ...
                    <td style="width: 300px;">
                        <asp:TextBox ID="txtName" MaxLength="200" runat="server" Width="275px"></asp:TextBox>
                    ...
                    <td class="style1" align="right" colspan="2">
                        <asp:DropDownList ID="ddlName" Width="300px" runat="server"  AutoPostBack="true"
                ...
                <tr>
                    ...
                    <td style="width: 300px;">
                        <asp:TextBox ID="txtSubject" MaxLength="200" runat="server" Width="275px"></asp:TextBox>
                    </td>
                    <td style="width: 150px;">
                    </td>
                    <td style="width: 300px;" colspan="2">
                ...
                <tr>
                    ...
                    <td style="width: 300px;" colspan="2" align="left">
                        <asp:CheckBox ID="ChkLoc" runat="server" AutoPostBack="True" oncheckedchanged="ChkLoc_CheckedChanged" Text="نفس الجهات لكل البنود" />
                    </td>
                </tr>
            </table>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="م" SortExpression="FNo" ItemStyle-HorizontalAlign="Center">
                            ...
                            <asp:TemplateField HeaderText="من" SortExpression="PlaceofLoading" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlPlaceofLoading" runat="server" AutoPostBack="false" OnSelectedIndexChanged="ddlCarType_SelectedIndexChanged">
                                    </asp:DropDownList><br />
                                    <asp:TextBox ID="txtFrom2" MaxLength="100" runat="server" CssClass="spmargin" Text='<%# Bind("From2") %>' Width="275px"></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="إلى" SortExpression="Destination" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlDestination" runat="server"  AutoPostBack="false" OnSelectedIndexChanged="ddlModel_SelectedIndexChanged">
                                    </asp:DropDownList><br />
                                    <asp:TextBox ID="txtTo2" MaxLength="100" CssClass="spmargin" runat="server" Text='<%# Bind("To2") %>' Width="275px"></asp:TextBox>
                                </ItemTemplate>
                                <ControlStyle Width="130px"></ControlStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
            ...
            <table width="99%" cellpadding="5px" dir="rtl">
                <tr>
                    ...
                    <td style="width: 300px;" align="left">
                        <asp:CheckBox ID="ChkPrintTot" runat="server" Text="طباعة الاجمالي" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 150px;">
                    ...
                    <td style="width: 300px;">
                       <asp:TextBox ID="txtTotal" ReadOnly="true" Width="100px" MaxLength="15" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 150px;">
                    </td>
                    <td style="width: 300px;" align="left">
                ...
                <div class="DivButtons" style="width: 95%">
                    <table id="Table2" dir="rtl" width="100%" cellpadding="0" cellspacing="0">
                        <tr align="center">
                            ...
                            <td id="td1" runat="server" style="width: 200px; text-align: center;">
                                <asp:CheckBox ID="ChkGMApprove" Text="تعميد الرئيس التنفيذي" runat="server" />
                            </td>
                        </tr>
                    </table>
                </div>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="ColorRounded4Corners col-md-12 col-sm-12 col-xs-12">
        ...
        <legend align="right" style="font-size: 18px; color: #800000; text-align: center;"><b>[ اتفاقية خدمات الطريق ]</b></legend>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <asp:Button ID="BtnFind" CssClass="btn btn-primary" runat="server" ValidationGroup="55"
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <asp:TextBox ID="txtGDate" CssClass="form-control" runat="server" MaxLength="10"
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <asp:DropDownList ID="ddlitem" CssClass="form-control" runat="server" AutoPostBack="True"
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="form-group form-float">
                <div class="form-line">
                    ...
                    <asp:TextBox ID="txtprod" CssClass="form-control" runat="server"
        ...
        <legend align="right" style="font-size: 18px; color: #800000; text-align: center;"><b>[ تعيين السائق ]</b></legend>

        ...
        <div class="ColorRounded4Corners" style="width: 99.8%">
                ...
                <asp:GridView ID="grdCodes" runat="server" CellPadding="4" Width="99.95%" ForeColor="#333333"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Part Name" SortExpression="ITName2" ItemStyle-HorizontalAlign="Center">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtITName" Text='<%# Bind("ITName2") %>' autocomplete="off" runat="server" Width="200px"  />
                        ...
                        <asp:TemplateField HeaderText="Qty" SortExpression="Quan" ItemStyle-HorizontalAlign="Center">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtQuan" Text='<%# bind("Quan") %>' runat="server" Width="75px"></asp:TextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Price" SortExpression="Price" ItemStyle-HorizontalAlign="Center">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPrice" Text='<%# bind("Price") %>' runat="server" Width="75px"></asp:TextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
            ...
            <table width="100%" cellpadding="3" cellspacing="0" border="2px">
                ...
                <tr>
                    ...
                    <td style="width: 17%;">
                        <asp:TextBox ID="txtExpAmount" MaxLength="15" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td colspan="2" style="width: 32%;">
                        <asp:TextBox Width="99.5%" ID="txtExpRef" MaxLength="50" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 19%;">
                    </td>
                    <td style="width: 16%;">
                ...
                <tr align="center">
                    <td colspan="4" style="width: 100%;">
                        <asp:ImageButton ID="BtnNew" runat="server" AlternateText="New" CommandName="New"
                            ImageUrl="~/images/insource_641.png" CssClass="ops" ToolTip="Add New Purchase Invoice"
                        ...
                        <asp:ImageButton ID="BtnEdit" runat="server" AlternateText="Edit" CommandName="Edit"
                            ImageUrl="~/images/draw_pen_641.png" CssClass="ops" ToolTip="Edit Purchase Invoice"
                        ...
                        <asp:ImageButton ID="BtnDelete" runat="server" AlternateText="Delete" CommandName="Delete"
                            ImageUrl="~/images/cut_641.png" CssClass="ops" ToolTip="Delete Purchase Invoice"
                        ...
                        <asp:ImageButton ID="BtnSearch" runat="server" AlternateText="Find" CommandName="Find"
                            ImageUrl="~/images/binoculars_641.png" CssClass="ops" ToolTip="Search for Purchase Invoice"
                            OnClick="BtnSearch_Click" />
                        <asp:ImageButton ID="BtnPrint" runat="server" AlternateText="Print" CommandName="Print"
                            ImageUrl="~/images/print_641.png" ValidationGroup="1" CssClass="ops" ToolTip="Print Purchase Invoice"

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" class="sidebar-mini">
    ...
    <center id="center1" runat="server">
        <div class="minheight">
            <asp:Panel ID="Panel3" runat="server" Height="300" CssClass="ShadowPanel" Width="90%"
                Direction="RightToLeft">
                <h2>
                    <asp:Label ID="Label4"  runat="server" ForeColor="#0D3D87" Text="تغيير كلمة المرور" meta:resourcekey="Label4"></asp:Label></h2>
                <center>
                    <table id="Table1" runat="server"  width="100%" cellpadding="2" style="color: Black;">
                        <tr id="tr1" runat="server">
                            ...
                            <td >
                                <asp:TextBox ID="txtOldPassword" CssClass="form-control" runat="server" MaxLength="50" TextMode="Password"></asp:TextBox>
                        ...
                        <tr id="tr2" runat="server">
                            ...
                            <td style="width: 250px">
                                <asp:TextBox ID="txtNewPassword" CssClass="form-control" runat="server" MaxLength="50" TextMode="Password"></asp:TextBox>
                        ...
                        <tr id="tr3" runat="server">
                            ...
                            <td style="width: 250px">
                                <asp:TextBox ID="txtNewPassword2" CssClass="form-control" runat="server" MaxLength="50" TextMode="Password"></asp:TextBox>

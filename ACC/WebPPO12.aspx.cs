...
namespace Pro
{
    public partial class WebPPO12 : System.Web.UI.Page
    {
        ...
        public void NewMode()
        {
            ...
            if (!(bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass272) ControlsOnOff(false);
        }
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                    {
                        ...
                        UserTran.Description = "تم اختيار صفحة طلب دفع";
        ...
        protected void BtnNew_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    if (txtAmount.Text != "" && AreaNo!="00000")
                    {
                    ...
                    if (Saveall())
                    {
                        if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                        {
                            ...
                            UserTran.Description = "اضافة بيانات طلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                            UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                        }
                        ...
                        if (inv.Delete(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            if (Saveall())
                            {
                                if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                                {
                                    ...
                                    UserTran.Description = "تعديل بيانات طلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                    ...
                    else
                    {
                        ...
                        if (inv.Delete(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                            {
                                ...
                                UserTran.Description = "الغاء بيانات طلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                                UserTran.Reason = txtReason.Text;
                                UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                            }
                            txtReason.Text = "";
                ...
                if (txtVouNo.Text != "")
                {
                    ...
                    else
                    {
                        if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                        {
                            ...
                            UserTran.Description = "عرض بيانات طلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                            UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                        }
            ...
            try
            {
                      if (Page.IsValid)
                      {
                          if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                          {
                              ...
                              UserTran.Description = "طباعة بيانات طلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                              UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                          }
                          ...
                          cell.Phrase = new iTextSharp.text.Phrase("سند الصرف", nationalTextFont);
                          table.AddCell(cell);
                          //
            ...
            try
            {
                if (e.CommandName.Equals("Insert"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            txtVouNo2.Text = int.Parse(AreaNo).ToString() + "/" +txtVouNo2.Text;
                        }
                        ...
                        myJv.Branch = short.Parse(Session["Branch"].ToString());
                        myJv.FType = 102;
                        if(AreaNo != "00000") myJv.LocType = 2;
                        else myJv.LocType = 1;
                        myJv.LocNumber = short.Parse(AreaNo);
                        myJv.Number = Number;
        ...
        private void MakeSum()
        {
            try
            {
                ...
                if (txtAmount.Text != "" && AreaNo != "00000" && Request.QueryString["FMode"] == null)
                {
                    if (moh.StrToDouble(txtAmount.Text) > SiteInfo.CrLimit)
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
            ...
            if (FileUpload1.HasFile)
                try
                {
                    ...
                    if(mySetting!=null)
                    {
                        ...
                        {
                            Transactions UserTran = new Transactions();
                            UserTran.TranDate = String.Format("{:dd/MM/yyyy}", moh.Nows());
                            UserTran.TranTime = String.Format("{0:HH:mm:ss}", moh.Nows());
                            UserTran.UserName = Session["CurrentUser"].ToString();
                            UserTran.FormName = "طلب دفع";
                            UserTran.FormAction = "اضافة مرفقات";
                            UserTran.Description = "اضافة مرفقات لطلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                            UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                        }
        ...
        protected void grdAttach_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1")
                {
                    ...
                    UserTran.Description = "الغاء مرفقات لطلب دفع رقم " + lblBranch2.Text + "/" + txtVouNo.Text;
                    UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                }
            ...
            try
            {
                ...
                if (myCar != null)
                {
                    ...
                    if (myPrice != null)
                    {
                        ...
                        myDrive = myDrive.Find(WebConfigurationManager.ConnectionStrings[HttpContext.Current.Session["CNN"].ToString()].ConnectionString);
                        if (myDrive != null)
                        {
                            vstr1 = myDrive.Name1;
                        }                        

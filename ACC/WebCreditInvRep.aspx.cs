...
namespace ACC
{
    public partial class WebCreditInvRep : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    this.Page.Header.Title = "بيان الفواتير الآجلة";
                    ...
                    if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1") moh.AddUserTrans(Session["CurrentUser"].ToString(), "الرئيسية", "اختيار", "اختيار عرض بيان الفواتير الآجلة", "", IPNetworking.GetIP4Address(), WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);                
                    ...
                    ddlSite.Enabled = (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass461;
                    ChkSite.Enabled = (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass461;
        ...
        protected void ddlBranch_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ddlSite.DataSource = myInv.CreditGetSite(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
                ddlSite.DataBind();

                ddlCustomer.DataTextField = "CustomerName";
                ddlCustomer.DataValueField = "Customer";
                ddlCustomer.DataSource = myInv.CreditGetCustomer(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
        ...
        protected void BtnPrint1_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1") moh.AddUserTrans(Session["CurrentUser"].ToString(), "بيان الفواتير الآجلة", "طباعة", "اختيار طباعة بيان الفواتير الآجلة " + (ChkSite.Checked ? "جميع الفروع" : ddlSite.SelectedItem.Text) + " " + (ChkCustomer.Checked ? "جميع العملاء " : ddlCustomer.SelectedItem.Text) + (ChkPeriod.Checked ? "جميع الفترات " : txtFDate.Text + " إلى " + txtEDate.Text), "", IPNetworking.GetIP4Address(), WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);                
                ...
                {
                    cell2.Phrase = new iTextSharp.text.Phrase(" بيان الفواتير الآجلة عن جميع الفترات ", nationalTextFont16);
                }
                else
                {
                    cell2.Phrase = new iTextSharp.text.Phrase(" بيان الفواتير الآجلة عن الفترة من  " + txtFDate.Text + " إلى " + txtEDate.Text, nationalTextFont16);
                }
                table.AddCell(cell2);
                ...
                document.Add(new iTextSharp.text.Phrase("            ", nationalTextFont));
                //-------------------------------------------------------------------------------------------
                cols = new[] { 150, 200, 200, 150, 120, 120, 120, 100, 100, 50 };
        ...
        {
            if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1") moh.AddUserTrans(Session["CurrentUser"].ToString(), "بيان الفواتير الآجلة", "تصدير", "اختيار تصدير بيان الفواتير الآجلة " + (ChkSite.Checked ? "جميع الفروع" : ddlSite.SelectedItem.Text) + " " + (ChkCustomer.Checked ? "جميع العملاء " : ddlCustomer.SelectedItem.Text) + (ChkPeriod.Checked ? "جميع الفترات " : txtFDate.Text + " إلى " + txtEDate.Text), "", IPNetworking.GetIP4Address(), WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);                
            Response.Clear();
        ...
        protected void BtnProcess_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings["TraceUserLog"].ToString() == "1") moh.AddUserTrans(Session["CurrentUser"].ToString(), "بيان الفواتير الآجلة", "عرض", "اختيار عرض بيان الفواتير الآجلة " + (ChkSite.Checked ? "جميع الفروع" : ddlSite.SelectedItem.Text) + " " + (ChkCustomer.Checked ? "جميع العملاء " : ddlCustomer.SelectedItem.Text) + (ChkPeriod.Checked ? "جميع الفترات " : txtFDate.Text + " إلى " + txtEDate.Text), "", IPNetworking.GetIP4Address(), WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);                
                lblCount.Text = "";
                MyOver.Clear();
                vInvError myInv = new vInvError();
                myInv.VouLoc = ddlBranch.SelectedValue;
                myInv.Site = ChkSite.Checked ? "" : ddlSite.SelectedValue;
                myInv.Customer = ChkCustomer.Checked ? "" : ddlCustomer.SelectedValue;
                MyOver = myInv.CreditGetAll(txtFDate.Text, txtEDate.Text, WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString);
                LoadCodesData();
            }
            catch (Exception ex)
            {
        ...
        protected string UrlHelper(object FType, object Number)
        {
            ...
            if (vs.Count() > 1)
            {
                ...
                {
                    case 1: return (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass462 ? "~/WebInvoice.aspx?FNum=" + vs[1] + "&AreaNo=" + moh.MakeMask(vs[0], 5) + "&Flag=0&StoreNo=" + StoreNo : "";
                    case 2: return (bool)((List<TblRoles>)(Session[vRoleName]))[1].Pass463 ? "~/WebRVou1.aspx?FNum=" + vs[1] + "&AreaNo=" + moh.MakeMask(vs[0], 5) + "&Flag=0&StoreNo=" + StoreNo : "";
                    default: return "";
                }
            }
            else return "";

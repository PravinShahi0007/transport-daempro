...
namespace ACC
{
    public partial class WebDeliveryNote : System.Web.UI.Page
    {
        ...
        public void EditMode()
        {
            ...
            BtnPrint.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass325;
            BtnBarCode.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass325;
            BtnBarCode.Visible = true;
            BtnEdit.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass322;
            BtnNew.Visible = false;
            BtnDelete.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass323;
        }
        ...
        public void NewMode()
        {
            ...
            BtnNew.Visible = true && (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass321;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    this.Page.Header.Title = "Delivery Note";

                    BtnNew.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass321;
                    BtnEdit.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass322;
                    BtnDelete.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass323;
                    BtnSearch.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass324;
                    BtnPrint.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass325;
                    BtnBarCode.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass325;
                    BtnBarCode.Visible = true;
                    BtnFind.Visible = (bool)((List<TblRoles>)(Session["Roll"]))[2].Pass324;
                    ...
                    else
                    {
                        ...
                        if (Request.QueryString["ManInventory"] != null && Session["ManInventory"] != null)
                        {
                            ...
                            txtRemark.Text = "الاصناف الزائدة عن الجرد عن " + ((List<vyStock>)Session["ManInventory"])[0].FYear.Substring(6, 4);
                            foreach (vyStock itm in (List<vyStock>)Session["ManInventory"])
                            {
                                if (itm.FAdd > 0)
                                {
                                    ...
                                    if (myItem != null)
                                    {
                                        ...
                                        myAccess.Quan = itm.FAdd;
                                        myAccess.Price = itm.Price;
                                        myAccess.Remark = "الاصناف الزائدة عن الجرد عن " + itm.FYear.Substring(6,4);
                                        myAccess.InvType = 0;
                            ...
                            MakeSum();
                            LoadVouData();
                            BtnAdd.NavigateUrl = @"~\WebPurchaseInvoice.aspx?ManInventory=1&AreaNo=" + AreaNo + "&StoreNo=" + StoreNo + "&Ref="+txtVouNo.Text;
                            BtnAdd.Visible = true;
                        }
                    }
                }
            ...
            try
            {
                if (Page.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        {
                            LblCodesResult.ForeColor = System.Drawing.Color.Red;
                            LblCodesResult.Text = "Delivery Note No. Related to Purchase Invoice";
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                            if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                            return;
                        }
                        ...
                        if (myJv.Delete(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            UserTran.Description = "Delete Delivery Note No. " + txtVouNo.Text;
                            UserTran.FormAction = "Delete";
                            UserTran.FormName = "Delivery Note";
            ...
            try
            {
                if (txtVouNo.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        myStp.RefNo = int.Parse(txtVouNo.Text);
                        myStp.InvType = 0;
                        myStp.Ftype = 501;
                        foreach (STP itm in myStp.FindRef2(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            if (lblStatus.Text == "") lblStatus.Text = "Releated to Purchase Inv.#:" + @"<a href='WebPurchaseInvoice.aspx?Flag=0&AreaNo=" + AreaNo + "&StoreNo=" + itm.VouLoc.ToString() + "&FNum=" + itm.VouNo.ToString() + @"' target='_blank'>" + itm.VouNo.ToString() + @"</a>";
                            else lblStatus.Text += @"&nbsp;&nbsp;&nbsp;" + @"<a href='WebPurchaseInvoice.aspx?Flag=0&AreaNo=" + AreaNo + "&StoreNo=" + itm.VouLoc.ToString() + "&FNum=" + itm.VouNo.ToString() + @"' target='_blank'>" + itm.VouNo.ToString() + @"</a>";
                        }
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ajax", @"<script language='javascript'> window.open('WebPrint.aspx?FType=203&AreaNo=" + StoreNo + "&Number=" + Number + "');</script>", false);
            return;
        }
        ...
        */
        ...
        protected void BtnFind2_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (txtRefNo.Text != "")
                {
                    int RefVouNo = 0;
                    short RefVouLoc = 1;
                    if (txtRefNo.Text.Split('/').Count() > 1)
                    {
                        RefVouNo = int.Parse(txtRefNo.Text.Split('/')[0]);
                        RefVouLoc = short.Parse(txtRefNo.Text.Split('/')[1]);
                    }
                    else
                    {
                        RefVouNo = int.Parse(txtRefNo.Text);
                        RefVouLoc = short.Parse(StoreNo);
                    }

                    if (ddlRefType.SelectedIndex == 0 && RefVouLoc != short.Parse(StoreNo))
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
                        LblCodesResult.Text = "Purchase Order No. Should Be From Same Branch";
                        if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                        return;
                    }
                    ...
                    myPo.InvType = (short)ddlRefType.SelectedIndex;
                    myPo.Ftype = 601;
                    myPo.RefNo = RefVouNo;
                    myPo.RefNoLoc = RefVouLoc;

                    bool vFind = false;
                    int VouNo = 0;
                    foreach (STP itm in myPo.FindRef(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                    {
                    ...
                    foreach (vSTP itm in VouData)
                    {
                        if (itm.RefNo == RefVouNo && itm.RefNoLoc == RefVouLoc)
                        {
                            vFind = true;
                            break;
                        }
                    ...
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;
                        LblCodesResult.Text = "Purchase Order No. Used before in same Delivery Note ";
                        if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                        return;
                    }
                    ...
                    else
                    {
                        ...
                        foreach (vPO itm in myJv.Find2(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                        {
                            ...
                            VouData.Add(
                                            new vSTP
                                            {
                                                ...
                                                Branch = itm.Branch,
                                                Price = itm.Price,
                                                Quan = (itm.Quan - itm.Quan2 < 0 ? 0 : itm.Quan - itm.Quan2) ,
                                                ...
                                                FNo2 = itm.FNo,
                                                Bal = (myStock != null ? myStock.IOpen + myStock.IPurch - myStock.ISale : 0)
                                            }
                                );
                        }
                        if (VouNo > 0 && !vFind)
                        {
                            LblCodesResult.ForeColor = System.Drawing.Color.Red;
                            LblCodesResult.Text = "Closed Purchase Order No. and Used before in Delivery Note No. " + VouNo.ToString();
                            if (VouData.Count() < 1) grdCodes_RowCancelingEdit(sender, null);
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, true, (bool)Session["Modal"]), true);
                            return;
                        }
        ...
        protected void BtnBarCode_Click(object sender, ImageClickEventArgs e)
        {
            if(Session["Barcode_"+Session["CurrentUser"].ToString()] != null) Session.Remove("Barcode_"+Session["CurrentUser"].ToString());
            Session.Add("Barcode_"+Session["CurrentUser"].ToString(), VouData);
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ajax", @"<script language='javascript'> window.open('WebBarCode.aspx?&AreaNo=" + AreaNo + @"&StoreNo=" + StoreNo + "');</script>", false);
        }
            ...
            try
            {
                if (chkAgree1.Checked)
                {
                    ...
                    if (myAgree.Add(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                    {
                        ...
                        UserTran.TranTime = String.Format("{0:HH:mm:ss}", moh.Nows());
                        UserTran.UserName = Session["CurrentUser"].ToString();
                        UserTran.Description = "أعتماد سند اضافة رقم  " + txtVouNo.Text;
            ...
            try
            {
                if (chkAgree2.Checked)
                {
                    ...
                    if (myAgree.Add(WebConfigurationManager.ConnectionStrings[Session["CNN"].ToString()].ConnectionString))
                    {
                        ...
                        UserTran.TranTime = String.Format("{0:HH:mm:ss}", moh.Nows());
                        UserTran.UserName = Session["CurrentUser"].ToString();
                        UserTran.Description = "أعتماد سند أضافة رقم  " + txtVouNo.Text;
                        UserTran.FormAction = "أعتماد";
                        UserTran.FormName = "Delivery Note";                       
                        UserTran.IP = IPNetworking.GetIP4Address();
                        UserTran.Add(WebConfigurationManager.ConnectionStrings["MyCnnlog"].ConnectionString);
                        ...
                        //ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), Guid.NewGuid().ToString(), moh.DisptopMessage(LblCodesResult.Text, false, true), true);
                        Response.Redirect(@"WebPurchaseInvoice.aspx?AreaNo=" + AreaNo + @"&StoreNo=" + StoreNo + @"&FNum2=" + txtVouNo.Text );
                    }
                    else
                    {
                        LblCodesResult.ForeColor = System.Drawing.Color.Red;

    ...
    public class Taxi
    {
        ...
        public bool Add(string ConnectionStr)
        {
            try
            {
                ...
                {
                    myContext.TaxiInsert(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
                                                this.GDate,
                                                this.HDate,                                                
        ...
        public bool Update(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiUpdate(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
                                                this.GDate,
                                                this.HDate,
        ...
        public bool StatusUpdate(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiStatusUpdate(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
                                                this.Status);
                    return true;
        ...
        public bool StatusDriverUpdate(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiStatusDriverUpdate(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
        ...
        public bool UpdateDriverNote(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiDriverNoteUpdate(this.Branch,
                                            this.VouLoc,
                                            this.VouNo,
                                            this.DriverNote);
                    return true;
        ...
        public bool UpdateOrderIssue(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiOrderIssueUpdate(this.Branch,
                                            this.VouLoc,
                                            this.VouNo,
                                            this.OrderIssue);
                    return true;
        ...
        public bool doCancel(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiCancel(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
        ...
        public bool doRate(string DriverID,string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiRate(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
        ...
        public bool doCustRate(string CustID,string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiCustRate(this.Branch,
                                                this.VouLoc,
                                                this.VouNo,
        ...
        public bool Delete(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TaxiDelete(Branch, VouLoc, VouNo);
                    return true;
                }
            }
            catch (Exception)
        ...
        public List<Taxi> GetAll(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiGetAll();
        ...
        /// </summary>
        /// <returns>null</returns>
        public Taxi Find(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiFind(Branch, VouLoc, VouNo);
                    return (from Sitm in result
                            select new Taxi
                            {
                                Branch = Sitm.Branch,
        ...
        public List<Taxi> GetByUserID(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiGetByUserID(this.IDUser);
        ...
        public List<Taxi> GetByUserIDStatus(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiGetByIDUserStatus(this.IDUser, this.Status);
                    return (from itm in result
                            select new Taxi
                            {
                                Branch = itm.Branch,
        ...
        public List<Taxi> GetByDriverIDStatus(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiGetByIDdriverStatus(this.IDdriver, this.Status);
                    return (from itm in result
                            select new Taxi
                            {
                                Branch = itm.Branch,
        ...
        public List<Taxi> GetByStatus(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiGetByStatus(this.Status);
                    return (from itm in result
                            select new Taxi
                            {
                                Branch = itm.Branch,
        ...
        public int? GetMax(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    var result = myContext.TaxiMaxCode(this.Branch, this.VouLoc);

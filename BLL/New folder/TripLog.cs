    ...
    public class TripLog
    {
        ...
        public bool Add(string ConnectionStr)
        {
            try
            {
                ...
                {
                    myContext.TripLogAdd(this.Branch, this.VouLoc, this.VouNo, this.FNo, this.FType, this.DriverId, this.FDate, this.FTime, this.ActType);
                    return true;
                }
            }
            catch (Exception)
        ...
        public bool update(string ConnectionStr)
        {
            try
            {
                using (DataERP3DataContext myContext = new DataERP3DataContext(ConnectionStr))
                {
                    myContext.TripLogUpdate(this.Branch, this.VouLoc, this.VouNo, this.FNo, this.FType, this.DriverId, this.FDate, this.FTime, this.ActType);
                    return true;
                }
            }
            catch (Exception)
